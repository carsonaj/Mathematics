...
\end{proof}		
	...
	\begin{ex} \tbf{Topological Manifold Chart Lemma:} \\
		...
		\end{enumerate}
		Define $$\MB = \{\phi_{\al}^{-1}(V): V \subset \H^n \text{ is open in $\H^n$ and $\al \in A$} \}$$
		Then  
		\begin{enumerate}
	...
	\begin{proof} \
		\begin{enumerate}
			\item \begin{itemize}
				...
				\item Let $A_1, A_2 \in \MB$ and $p \in A_1 \cap A_2$. By definition, there exist $\al_1, \al_2 \in A$ and $B_1, B_2 \subset \H^n$ such that $B_1$, $B_2$ are open in $\H^n$ and 
				\begin{align*}
