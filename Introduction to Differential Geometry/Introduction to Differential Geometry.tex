...
%	\end{defn}
	...
	\begin{defn} \ld{def:immersions:0001}
		Let $(M, \MA), (N, \MB) \in \Obj(\Maninfbnd)$ and $F \in \Hom_{\Maninfbnd}((M, \MA), (N, \MB))$. Then $F$ is said to be a \tbf{$\Maninfbnd$-immersion} if for each $p \in M$, $DF(p):T_pM\rightarrow T_{F(p)}N$ is injective.
	\end{defn}
	...
	\begin{defn}  \ld{def:immersions:0003}
		Let $(M, \MT_M, \MA_M), (N, \MT_N, \MA_N) \in \Obj(\Maninfbnd)$ and $F \in \Hom_{\Maninfbnd}((M, \MT_M, \MA_M), (N, \MT_N, \MA_N) )$. Then $F$ is said to be a \tbf{$\Maninfbnd$-embedding} if 
		\begin{enumerate}
