...
\end{enumerate}	
	...
	\begin{ex}
	Let $X, Y$ be Banach spaces, $A \subset X$ open, $f,g :A \rightarrow Y$, $\lam \in \C$ and $x_0 \in A$. If $f, g$ are Gateaux differentiable at $x_0$, then $f + \lam g$ Gateaux differentiable at $x_0$ and $d[f+\lam g](x_0) = df(x_0) + \lam dg(x_0)$.
	\end{ex}
	...
	\begin{ex}
	Let $X, Y$ be Banach spaces, $A \subset X$ open, $f:A \rightarrow Y$ and $x_0 \in A$. Suppose that $f$ is Gateaux differentiable at $x_0$. Then for each $\lam \in \C$ and $x \in X$, $$df(x_0)(\lam x) = \lam df(x_0)(x) \in X^*$$
	\end{ex}
	
	\begin{proof}
	Let $\lam \in \C$ and $x \in X$. Then 
	\begin{align*}
	df(x_0)(\lam x) 
