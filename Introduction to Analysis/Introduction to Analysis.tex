...
\end{align*}	 
	...
	Let $Y$ be a separable Banach space, $f:[a,b] \rightarrow Y$ continuous and $c \in Y$. Then $f$ is Bochner integrable and the map $F: (a,b) \rightarrow Y$ defined by $$F(x) = \int_{[0, x]}f dm + c$$ is Frechet differentiable and for each $x_0 \in (a,b)$, $$Df(x_0)(h) = f(x_0)h$$
	\end{ex}
	...
	&< \infty
\end{align*}
	so that $f \in L^1_Y$ and $f$ is Bochner integrable. 	Let $x_0 \in (a,b)$ and $h \in (0, b-x_0)$. Then continuity implies that
	\begin{align*}
...
So $$\int_{[x_0, x_0 + h]}f - f(x_0) dm = o(h) \hspace{1cm}\text{ as }h \rightarrow 0$$ 
	...
	\end{align*}
	So $F$ is Frechet differentiable at $x_0$ and $DF(x_0)(h) = f(x_0)h$.
	\end{proof}
