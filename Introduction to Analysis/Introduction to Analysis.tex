...
Then $V_{\ep}^o \in \MN_{x_0}$ is open and 
	...
	\begin{ex}
		Let $X$ be a vector space, $p: X \rightarrow \R$ a seminorm and $\phi \in X^*$. Then $\phi \leq p$ iff $|\phi| \leq p$. 
	\end{ex}
	...
	\begin{defn}
		Let $X$ be a vector space and $p:X \rightarrow \Rg$ be a seminorm on $X$. We define the \textbf{kernel of $p$}, denoted $N_p$, by $N_p = p^{-1}(\{0\})$.
	\end{defn}
	
	\begin{ex}
		Let $X$ be a vector space and $p: X \rightarrow \Rg$ a seminorm. Then $N_p$ is a subspace of $X$.
	\end{ex}
	
	\begin{proof}
		Let $x, y \in N_p$ and $\lam \in \C$. Then $p(x) = p(y) = 0$. Thus 
		\begin{align*}
			p(x + \lam y) 
			&\leq p(x) + p(\lam y) \\
			&= p(x) + |\lam|p(y) \\
	...
	\begin{defn}
		Let $X$ be a vector space and $p:X \rightarrow [0, \infty)$ a seminorm on $X$. We define the \textbf{norm induced by $p$}, denoted $\bar{p} : X / N_p \rightarrow  \Rg$, by $$\bar{p}(\bar{x}) = p(x)$$
	\end{defn}
	
	\begin{ex}
		Let $X$ be a vector space and $p:X \rightarrow [0, \infty)$ a seminorm on $X$. Then $\bar{p} : X / N_p \rightarrow  \Rg$ is well defined and a norm. 
	\end{ex}
	
	\begin{proof}
		Let $x, y \in X$. Suppose that $\bar{x} = \bar{y}$. Then there exists $n \in N_p$ such that $x = y + n$. Therefore, 
		\begin{align*}
			\bar{p}(\bar{x}) 
			&= p(x) \\
			&= p(y + n) \\
		...
		\begin{align*}
			...
			&= \bar{p}(\bar{x})
		\end{align*}
		So $\bar{p}(\bar{x}) = \bar{p}(\bar{y})$ and $\bar{p}: X / N_p \rightarrow \Rg$ is well defined. Let $x \in X$. Suppose that $\bar{x} = \bar{0}$. Then there exists $n \in N_p$ such that $x = n$. Therefore 
		\begin{align*}
			\bar{p}(\bar{x}) 
			&= p(x) \\
			&= p(n) \\
	...
	\begin{defn}
		Let $X$ be a vector space and $p:X \rightarrow [0, \infty)$ a seminorm on $X$. We equip $X / N_p$ with the topology induced by the norm $\bar{p}:X / N_p \rightarrow \Rg$. We define the projection $\pi_p: X \rightarrow X / N_p$ by $\pi_p(x) = \bar{x} = x + N_p$.
	\end{defn}
	
	\begin{defn}
		Let $X$ be a vector space and $\MP$ a collection of seminorms on $X$. Then $\MP$ is said to \textbf{separate points of $X$} if for each $x \in X$, if $x \neq 0$, then there exists $p \in \MP$ such that $p(x) \neq 0$.
	\end{defn}
	
	\begin{defn}
		Let $X$ be a vector space and $\MT$ a topology on $X$. Then $(X, \MT)$ is said to be a \textbf{locally convex space} if there exists a collection $\MP$ of seminorms on $X$ such that 
		\begin{itemize}
	...
	\begin{proof}\
		\begin{enumerate}
			...
			\item Let $x, y \in X$. Suppose that $x \neq y$. Since $\MP$ separates points of $X$, there exists $p \in \MP$ such that $p(x - y) \neq 0$. Thus $\bar{p}(\bar{x} - \bar{y}) \neq 0$. Thus $\bar{x} \neq \bar{y}$. Since $X / N_p$ is Hausdorff, there exists $U' \in \MN_{\bar{x}}$ and $V' \in \MN_{\bar{y}}$ such that $U' \cap V' = \varnothing$. Set $U = \pi_p^{-1}(U')$ and $V =  \pi_p^{-1}(V')$. Then $U \in \MN_x$, $V \in \MN_y$ and  
			\begin{align*}
				U \cap V 
	...
	\begin{ex}
		Let $X$ be a locally convex space and $\phi :X \rightarrow \C$ linear. Then $\phi \in X^*$ iff there exists $p \in \MP$ such that $|\phi| \leq p$.
	\end{ex}
	...
	\begin{defn}
		Let $X$ be a vector space and $A \subset X$. For $x \in X$, set $$T_x = \{t > 0: x \in tA\}$$ We define the \textbf{Minkowski functional}, denoted $p_A: X \rightarrow \RG$, by $$p_A(x) = \inf T_x$$ 
	\end{defn}
	
	\begin{ex}
		Let $X$ be a vector space and $A \subset X$. Suppose that $A$ is convex, absorbing and balanced. Then 
		\begin{enumerate}
	...
	\begin{proof} Let $x, y \in X$ and $\lam \in \C$. 
		\begin{enumerate}
			...
			\end{align*}
			\item \begin{itemize}
				\item Let $\ep >0$. Choose $t_x \in T_x$ and $t_y \in T_y$ such that $t_x < p_A(x) + \ep/2$ and $t_y < p_A(y) + \ep/2$. By definition, $t_x^{-1}x$, $t_y^{-1}y \in A$. Set $\theta = t_x(t_x +t_y)^{-1} \in (0, 1)$. Since $A$ is convex, 
				\begin{align*}
					(t_x +t_y)^{-1}(x+y) 
					...
					& \in A
				\end{align*}
				Therefore, $t_x + t_y \in T_{x+y}$ and 
				\begin{align*}
					p_A(x+y) 
					& \leq t_x + t_y \\
...
\begin{defn}
Let $X$ be a normed vector space. We define the \textbf{weak topology on $X$} to be the weak topology generated by $X^*$. 
\end{defn}

\begin{defn}
Let $X$ be a normed vector space, $(x_{\al})_{\al} \subset X$ and $x \in x$. Then $(x_{\al})_{\al}$ is said to \textbf{converge weakly to $x$}, denoted $x_{\al} \conv{w} x$ if $(x_{\al})_{\al}$ converges to $x$ in the weak topology.
\end{defn}

\begin{ex} \lex{}
Let $X$ be a normed vector, $(x_{\al})_{\al \in A} \subset X$ a net and $x \in X$. Then $x_{\al} \rightarrow x$ iff for each $T \in X^*$, $Tx_{\al} \rightarrow Tx$. 
\end{ex}
...
\begin{defn}
Let $X$ be a normed vector space. We define the \textbf{weak-* topology on $X^*$} to be the weak topology generated by $\hat{X}$. 
\end{defn}
