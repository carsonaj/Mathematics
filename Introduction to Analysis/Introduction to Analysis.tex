...
\begin{document}
	...
	\begin{defn} \ld{def:set_theory:relations:orderings:0001} \tbf{Directed Set:} \\
		Let $A$ be a set and $\leq \, \subset A \times A$ a binary relation on $A$. Then $(A, \leq)$ is said to be a \tbf{directed set} if , 
		\begin{enumerate}
			\item $A \neq \varnothing$
	...
	\begin{defn} \ld{def:set_theory:relations:orderings:0002} \tbf{Poset:} \\
		Let $A$ be a set and $\leq \, \subset A \times A$ a binary relation on $A$. Then 
		\begin{itemize}
			\item $\leq$ is said to be a \tbf{ partial ordering on $A$} if for each $a,b,c \in A$,
			\begin{enumerate}
				\item $a \leq a$,
				\item $a \leq b$ and $b \leq a$ implies that $a = b$,
				\item $a \leq b$ and $b \leq c$ implies that $a \leq c$.
			\end{enumerate}
			\item $(A, \leq)$ is $(A, \leq)$ is said to be a \tbf{partially ordered set} or \tbf{poset} if
...
We define the \tbf{topology generated by $\ME$} on $X$, denoted $\tau(\ME)$, by $$\tau(\ME) = \bigcap_{\MT \in \MS} \MT$$
	...
	\begin{defn} \ld{31012}
	Let $(X, \MT)$ be a topological space and $S,N \subset X$. Then $N$ is said to be a \tbf{neighborhood} of $S$ if there exists $U \in \MT$ such that $S \subset U \subset N$. For $S \in X$, we denote the set of neighborhoods of $S$ by $\MN_{\MT}(S)$.
	\end{defn}
	...
	\begin{itemize}
		...
		the \tbf{interior of A}, denoted $\Int A$, by 
		$$\Int A = \bigcup_{U \in \MU_{A}(X, \MT)} U$$ 
		the \tbf{closure of A}, denoted $\cl A$, by 
	...
	\begin{proof}
		Suppose that $N \in \MN(S)$. By definition, there exists $U \subset X$ such that $U$ is open and $S \subset U \subset N$. Since $U$ is open and $U \subset N$, \rd{31013} implies that
		\begin{align*}
			S
			& \subset U \\
			& \subset \Int N 
	...
	\begin{defn} \ld{31018}
	Let $X$ be a topological space, $A \subset X$ and $x \in X$. Then $x$ is said to be a \tbf{limit point of $A$} if for each $U \in \MN(x)$, $$A \cap (U \setminus \{x\}) \neq \varnothing$$  
...
\end{align*}	
	...
	\begin{defn} \lex{31026} 
		Let $X$ be a topological space, $A \subset X$ and $x \in X$. Then $x$ is said to be a \tbf{condensation point of $A$} if for each $U \in \MN(x)$, $U$ is open implies that $U \cap A$ is uncountable. 
	\end{defn}
...
\subsection{Common Directed Sets}
	...
	\begin{note}
		We recall the definition of a directed set from \rd{def:set_theory:relations:orderings:0001}.
	\end{note}
...
\end{align*}	
	...
	\begin{proof}\
		\begin{enumerate}
			...
			\item \tcb{An exercise in introduction section} and part $(1)$ implies that 
			\begin{align*}
				\p E
				& = (\cl E) \cap (\cl E^c) \\
				& = (\cl E) \cap (\Int E)^c \\
...
\end{proof}
	...
	\begin{note}
		Let $\Gam$ be a directed set and $\gam_0 \in \Gam$. From \rd{def:set_theory:nets:0002}, we recall the $\gam_0$-tail operator $L_{\gam_0}: X^{\Gam} \rightarrow X^{[\gam_0, \infty)}$. 
	\end{note}
...
%			Since $x \in \pi^{-1}(\pi(U))$ is arbitrary, we have that for each $x \in \pi^{-1}(\pi(U))$, there exists $U' \in \MT$ such that $x \in U'$ and $U' \subset \pi^{-1}(\pi(U))$. Hence $\pi^{-1}(\pi(U)) \in \MT$. Since $U \in \MT$ is arbitrary, we have that for each $U \in \MT$, $\pi^{-1}(\pi(U)) \in \MT$. Since $\pi: X \rightarrow X / \sim_0$ is a quotient map, 
	...
	\begin{ex} \lex{ex:topology:countability:0006}
	...
	\begin{defn} \ld{def:topology:countability:0011}
		...
		\tcb{NEED TO DEFINE COVER AND SUBCOVER}\\
		\tcb{FINISH!!!}
	\end{defn}
	...
	\begin{defn} \ld{def:ex:topology:countability:0012.01}
		Let $X$ be a topological space, $A \subset X$ and $x \in X$. Then $x$ is said to be a \tbf{condensation point of $A$} if for each $U \in \MN(x)$, $U \cap A$ is uncountable.
	\end{defn}
	
	\begin{ex} \lex{ex:topology:countability:0012.02}
		Let $(X, \MT)$ be a topological space. Define $C \subset X$ by 
		$$C \defeq \{x \in X: \text{$x$ is a condensation point of $X$}\}.$$
		Then 
		\begin{enumerate}
			\item for each $x \in X$, $x \in C^c$ iff there exists $U \in \MT$ such that $x \in U$, $U$ is countable and $U \subset C^c$. \tcr{Maybe move this part and definition to topology intro section with accumulation and limit points}
			\item $C$ is closed.
			\item $(X, \MT)$ is second-countable implies that $C^c$ is countable.
		\end{enumerate}
	\end{ex}
...
\end{proof}
	...
	\begin{defn} \ld{def:topology:compactness:00001}
	...
	\begin{defn} \ld{def:topology:compactness:00002}
	...
	\begin{ex} \lex{ex:topology:compactness:00005}
	...
	\begin{proof}\
		\begin{itemize}
			...
			\end{align*}
			Hence $\MU \cap K$ is an open cover of $K$ in $(K, \MT \cap K)$. Since $K$ is compact in $(X, \MT)$, \rex{ex:topology:compactness:00004} implies that $(K, \MT \cap K)$ is compact. By \rd{def:topology:compactness:00002}, there exists $\MV_0 \subset \MU \cap K$ such that $\MV_0$ is an open cover of $K$ in $(K, \MT \cap K)$ and $\MV_0$ is finite. Since $\MV_0 \subset \MU \cap K$, for each $V \in \MV_0$, there exists $U_V \in \MU$ such that $V = U_V \cap K$. Set $\MU_0 = \{U_V: V \in \MV_0\}$. Then $\MU_0 \subset \MU$. 
			\begin{enumerate}
				...
				\end{align*}
			\end{enumerate} 
			By \rd{def:topology:compactness:00001}, $\MU_0$ is an open cover of $K$ in $(X, \MT)$. By construction, $\MU_0$ is finite. 
			\item $(\impliedby)$: \\
	...
	\begin{ex} \lex{ex:topology:compactness:00006}
	...
	\begin{ex} \lex{ex:topology:compactness:00006.1}
		Let $(X, \MT)$ be a topological space and $E \subset X$. If $(X, \MT)$ is compact and $E$ is closed in $(X, \MT)$, then $E$ is compact in $(X, \MT)$.
	\end{ex}

	\begin{proof}
		Suppose that $(X, \MT)$ is compact and $E$ is closed in $(X, \MT)$. Let $\MU \subset \MP(X)$. Suppose that $\MU$ is an open cover of $E$ in $(X, \MT)$. Since $E$ is closed in $(X, \MT)$, $E^c \in \MT$. Set $\MU' = \MU \cup \{E^c\}$. Then $\MU' \subset \MT$ and $\MU'$ is an open cover of $X$ in $(X, \MT)$.  Since $(X, \MT)$ is compact, there exists $\MU'_0 \subset \MU'$ such that $\MU'_0$ is an open cover of $X$ in $(X, \MT)$ and $\MU'_0$ is finite. Set $\MU_0 = \MU'_0 \setminus \{E^c\}$. Then $\MU_0$ is an open cover for $E$ in $(X, \MT)$. Since $\MU$ such that $\MU$ is an open cover of $E$ in $(X, \MT)$ is arbitrary, \rex{ex:topology:compactness:00005} implies that $E$ is compact in $(X, \MT)$.
	...
	\begin{ex} \lex{ex:topology:compactness:00010}
	...
	\begin{ex} \lex{ex:topology:compactness:00011}
	...
	\begin{ex} \lex{ex:topology:compactness:00011.1}
	...
	\begin{defn} \ld{def:topology:compactness:00012}
	...
	\begin{ex} \lex{ex:topology:compactness:00013}
	...
	\begin{ex} \lex{ex:topology:compactness:00014}
	...
	\begin{ex} \lex{ex:topology:compactness:00015}
	...
	\begin{ex} \lex{ex:topology:compactness:00016}
	...
	\begin{ex} \lex{ex:topology:compactness:00017}
	...
	\begin{ex} \lex{ex:topology:compactness:00018} \tbf{Tychonoff's Theorem:} \\ 
	...
	\begin{proof}
 	...
 	\begin{ex} \lex{ex:topology:compactness:00019}
 	...
 	\begin{proof}\
 		\begin{enumerate}
 			...
 			\item 
 			\begin{enumerate}
 				\item \rex{ex:topology:compactness:00018} implies that $(Y, \MT_Y)$ is compact. Since $Y \subset \bigcup\limits_{y \in Y} V^y$ and $(Y, \MT_Y)$ is compact, there exists $y_1, \ldots, y_n \in Y$ such that $Y \subset \bigcup\limits_{j=1}^n V^{y_j}$. Set $U_{\al_0} \defeq \bigcap\limits_{j=1}^n U^{y_j}_{\al_0}$. Then $U_{\al_0} \in \MT_{\al_0}$ and $a \in U_{\al_0}$. 
 ...
 \begin{ex} \lex{ex:topology:compactness:00020}
 ...
 \begin{defn} \ld{def:topology:compactness:00014} 
...
\begin{proof}
	Clear by the previious exercise. \tcr{(add detail?)}
\end{proof}
...
\begin{ex} \ld{def:topology:compactness:00017.1}  \tbf{Closed Map Lemma:} \\
...
\begin{proof}\
	\begin{enumerate}
		\item Let $C \subset X$. Suppose that $C$ is closed in $(X, \MT_X)$. Since $(X, \MT_X)$ is compact, \rex{ex:topology:compactness:00006.1} implies that $C$ is compact in $(X, \MT_X)$. Since $f$ is continuous and $C$ is compact in $(X, \MT_X)$, \rex{ex:topology:compactness:00017} implies that $f(C)$ is compact in $(Y, \MT_Y)$. Since $(Y, \MT_Y)$ is Hausdorff, \rex{ex:topology:compactness:00006} implies that $f(C)$ is closed in $(Y, \MT_Y)$. Since $C \subset X$ with $C$ closed in $(X, \MT_X)$ is arbitrary, we have that for each $C \subset X$, $C$ is closed in $(X, \MT_X)$ implies that $f(C)$ is closed in $(Y, \MT_Y)$.
...
\end{proof}
 ...
 \begin{defn} \ld{def:topology:compactness:00018} 
...
\begin{proof}
	...
	Since $Y$ is LCH, there exists $K_y \in \MN(y)$ such that $K_y$ is compact. Since $Y$ is Hausdorff, \rex{ex:topology:compactness:00006} implies that $K_y$ is closed. Since $f$ is continuous, $f^{-1}(K_y)$ is closed. Hence $C \cap f^{-1}(K_y)$ is closed. Since $f$ is proper, $f^{-1}(K_y)$ is compact. \rex{ex:topology:compactness:00006.1} implies that $C \cap f^{-1}(K_y)$ is compact. Since $f$ is continous, $f(C \cap f^{-1}(K_y))$ is compact. \rex{ex:set_theory:functions:0004} implies that $f(C \cap f^{-1}(K_y)) = f(C) \cap K_y$. Since $f(C) \cap K_y$ is compact and $Y$ is Hausdorff, \rex{ex:topology:compactness:00006} implies that $f(C) \cap K_y$ is closed in $Y$.
...
\begin{defn} \ld{def:topology:proj_limits:0001}
	...
	\begin{enumerate}
		...
		\item $j \leq k$ and $k \leq l$ implies that $\pi_{j,k} \circ \pi_{k,l} = \pi_{j,l}$.
	\end{enumerate}
	Then $((X_j, \MT_j)_{j \in J}, (\pi_{j,k})_{(j,k) \in \leq})$ is said to be a \tbf{projective system of topological spaces}.
\end{defn}
...
\begin{ex} \lex{ex:topology:proj_limits:0005}
...
\begin{defn} \ld{def:topology:proj_limits:0007}
	...
	\begin{itemize}
		\item The projective limit $(X, (\pi_j)_{j \in J})$ is said to be \tbf{perfect} if for each $j \in J$, $\pi_j$ is a quotient map.
		...
		\begin{itemize}
			...
			\item the \tbf{quotient map induced by $\pi_j$}, denoted $\pi^Q_j:X \rightarrow X^Q_j$, by $\pi^Q_j(x) = \{y \in X: y \sim_j x\}$.
...
\begin{ex} \lex{ex:topology:proj_limits:0008}
...
\begin{proof}
	Suppose that for each $j \in J$, $X_j$ is a compact Hausdorff space and $\pi_j$ is surjective. Let $j \in J$. Since for each $j' \in J$, $X_{j'}$ is compact Hausdorff, \rex{ex:topology:proj_limits:0005} implies that $\pi_j$ is closed. Since $\pi_j$ is continuous, closed and surjective, \rex{ex:quotient_topology:0007} implies that $\pi_j$ is a quotient map. Since $j \in J$ is arbitrary, we have that for each $j \in J$, $\pi_j$ is a quotient map. Thus $X$ is perfect.
\end{proof}
...
\tcr{idea for existence of random fields: Let $A$ be a dense subset of $B$, use inverse limits to show existence of measure on $\C^A$, then use kolmogorov-chentsov theorem (kolmogorov continuity theorem) to extend to a measure on $\C^B$}
...
\begin{defn} \ld{def:metric_spaces:introduction:0009}
	...
	\begin{itemize}
		\item \tbf{open ball of radius $r$ at $x$}, denoted $B(x, r)$, by $$B(x, r) = \{y \in X: d(x,y) < r\}$$
		\item \tbf{closed ball of radius $r$ at $x$}, denoted $\bar{B}(x, r)$, by $$\bar{B}(x, r) = \{y \in X: d(x,y) \leq r\}$$
	\end{itemize}
\end{defn}
...
\begin{proof}
	Clear by \rex{ex:metric_spaces:introduction:0011}. 
\end{proof}
...
\begin{defn} \ld{def:metric_spaces:introduction:0021} \tcr{MOVE THIS!!!}
	Let $X$ be a topological space and $A \subset X$. Then 
	\begin{itemize}
		\item $A$ is said to be an \tbf{$F_{\sig}$-set} if there exist $(C_n)_{n \in \N} \subset \MP(X)$ such that for each $n \in \N$, $C_n$ is closed and $A = \bigcup\limits_{n \in \N} C_n$
...
\begin{ex} \lex{ex:metric_spaces:introduction:0024.2}
	Let $(X, d)$ be a complete separable metric space and $(U_n)_{n \in \N} \subset \MT_{d}$. Set $E \defeq \bigcap\limits_{n \in \N} U_n$ and define $C \subset X \times \R^{\N}$ and $f:E \rightarrow C$ by 
...
\begin{ex} \lex{ex:metric_spaces:introduction:0028}
	Let $(X,d)$ be a separable metric space. Suppose that $X \neq \varnothing$. Define $\Gam \defeq \{\N^{[n]}: n \in \N\}$. Then there exists $(C_{\gam})_{\gam \in \Gam} \subset \MP(X)$ such that 
	\begin{enumerate}
...
\begin{proof}
	...
	\begin{itemize}
		\item For $\gam \in \N^{[1]}$, we define $C_{\gam} \defeq \bar{B}(x^0_{\gam_1}, 2^{-1})$. 
		\item Let $n \geq 2$ and $\gam \in \N^{[n]}$. Define $\gam^0 \in \N^{n-1}$ by $\gam^0 \defeq \pi^{[n]}_{[n-1]}(\gam)$. Since $(x^0_j)_{j \in \N}$ is dense in $X$ and $C_{\gam_0} \neq \varnothing$, we have that $\# \{j \in \N: [\bar{B}(x^0_j, (2n)^{-1}) \cap C_{\gam_0}] \neq \varnothing\} = \infty$. Define $(x^{\gam_0}_j)_{j \in \N} \subset X$ to be an enumeration of $\{x^0_j: j \in \N \text{ and } [\bar{B}(x^0_j, (2n)^{-1}) \cap C_{\gam_0}] \neq \varnothing\}$. Define $C_{\gam} \subset C_{\gam_0}$ by $C_{\gam} \defeq \bar{B}(x^{\gam_0}_{\gam_n}, (2n)^{-1}) \cap C_{\gam_0}$.
	\end{itemize}
	\begin{enumerate}
		\item Let $\gam \in \Gam$. 
		\begin{enumerate}
			...
			\begin{itemize}
				...
				\begin{align*}
					...
					& = |\gam|^{-1}.
				\end{align*}
				\item Suppose that $n \geq 2$. Set $\gam_0 \defeq \pi^{[n]}_{[n-1]}(\gam)$. Then
				\begin{align*}
					\diam C_{\gam}
					& = \diam \bar{B}(x^{\gam_0}_{\gam_n}, (2n)^{-1}) \cap C_{\gam_0} \\
					& \leq \diam \bar{B}(x^{\gam_0}_{\gam_n}, (2n)^{-1}) \\
					& = n^{-1} \\
					& =|\gam|^{-1}.
				\end{align*}
			\end{itemize}
			...
			\begin{itemize}
				...
				\end{align*}
				Since $x \in C_{\gam}$ is arbitrary, we have that for each $x \in C_{\gam}$, $x \in \bigcup\limits_{\gam' \in (\pi^{[n+1]}_{[n]})^{-1}(\{\gam\})} C_{\gam'}$. Hence $C_{\gam} \subset \bigcup\limits_{\gam' \in (\pi^{[n+1]}_{[n]})^{-1}(\{\gam\})} C_{\gam'}$.
			\end{itemize}
			Since $\bigcup\limits_{\gam' \in (\pi^{[n+1]}_{[n]})^{-1}(\{\gam\})} C_{\gam'}
...
\subsubsection{Second-Countability and Zero-Dimensional Metric Spaces}

\begin{ex}
	Let $(X, d)$ be a separable metric space, $U \in \MT_d$ and $\ep > 0$. Suppose that $X$ is zero-dimensional and $U$ is not compact. Then there exists $(V_n)_{n \in \N} \subset \MT_d$ such that 
	\begin{itemize}
...
\begin{proof}
	\rex{ex:metric_spaces:introduction:0025} implies that $(X, \MT_d)$ is second-countable. Then \rex{ex:topology:countability:0013} implies that $(U, \MT_d \cap U)$ is second-countable. \rex{ex:topology:countability:0012} then implies that $(U, \MT_d \cap U)$ is Lindel\"{o}f. Since $U \in \MT_d$, we have that $\MT_d \cap U \subset \MT_d$. Since $U$ is not compact, there exists $\MV \subset \MT_d \cap U$ such that $\MV$ is an open cover of $U$ and for each $\MV' \subset \MV$, $\MV'$ is finite implies that $\MV'$ is not an open cover of $U$. Since $(X, \MT_d)$ is zero-dimensional, there exists $\MB \subset \MT_d$ such that $\MB$ is a basis for $\MT_d$ and for each $B \in \MB$, $B$ is closed. Define $\MW \subset \MT_d \cap U$ by $$\MW \defeq \{W \in \MT_d \cap U: \text{$W \neq \varnothing$, $W$ is closed, $\diam W \leq \ep$ and there exists $V \in \MV$ such that $W \subset V$}\}.$$
	Let $x \in U$. Since $\MV \subset \MT_d \cap U$ is an open cover of $U$, there exists $V \in \MV$ such that $x \in V$. Since $V \in \MT_d$, there exists $\ep' > 0$ such that $B(x, \ep') \subset V$. Set $\del \defeq \min(\ep/2, \ep')$. Then $B(x, \del) \subset V$ and $\diam B(x, \del) \leq \ep$. Since $\MB$ is a basis for $\MT_d$, there exists $B \in \MB$ such that $x \in B$ and $B \subset B(x, \del)$. Thus $B \neq \varnothing$, $B \subset V$ and $\diam B \leq \ep$. Hence $B \in \MW$. Since $x \in U$ is arbitrary, we have that for each $x \in U$, there exists $B \in \MW$ such that $x \in B$. Hence $\MW$ is an open cover of $U$. Since $(U, \MT_d \cap U)$ is Lindel\"{o}f, there exists $(W'_n)_{n \in \N} \subset \MW$ such that $(W'_n)_{n \in \N}$ is an open cover of $U$. Define $(W_n)_{n \in \N} \subset \MT_d \cap U$ by 
	\[
	W_n \defeq 
	\begin{cases}
		W_1', & n = 1 \\
...
\begin{defn}
	Let $(X,d)$ be a metric space and $S \subset X$. Then $S$ is said to be \tbf{discrete} if for each $x \in X$, there exists $r > 0$ such that $B(0, r) \cap X = \{x\}$. 
\end{defn}
...
\begin{proof}
	...
	\tcr{FINISH and then update proof of preserving cauchy sequences in completeness section}
\end{proof}
...
\begin{ex} \lex{ex:metric_spaces:metrizable_spaces:0001.001}
	Let $(X, \MT)$ be a topological space. Suppose that $(X, \MT)$ is separable and metrizable. Then there exists $B \subset [0,1]^{\N}$ and $f: X \rightarrow B$ such that $f$ is a homeomorphism. \\
	\tbf{Hint:} Let $(a_j)_{j \in \N} \subset X$ be a dense subset and consider $x \mapsto (d(x, a_j))_{j \in \N}$
\end{ex}

	\begin{proof}
		Since $(X, \MT)$ is metrizable, there exists a metric $d:X \times X \rightarrow [0,1]$ such that $\MT = \MT_d$. Since $(X, \MT)$ is separable, $(X, \MT)$ is separable. Thus there exists $(a_j)_{j \in \N}$ such that $(a_j)_{j \in \N}$ is dense in $(X, \MT)$. Define $B \subset [0,1]^{\N}$ and $f: X \rightarrow B$ by $B \defeq \{(d(x, a_j))_{j \in \N}: x \in X\}$ and $f(x) \defeq (d(x, a_j))_{j \in \N}$. 
		\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{align*}
				...
				& = f(y)
			\end{align*}
			in $[0,1]^{\N}$. Thus $x_n \rightarrow x$ implies that $f(x_n) \rightarrow f(x)$. Since $(x_n)_{n \in \N} \subset X$ and $x \in X$ are arbitrary, we have that for each $(x_n)_{n \in \N} \subset X$ and $x \in X$, $x_n \rightarrow x$ implies that $f(x_n) \rightarrow f(x)$. Hence $f$ is continuous.
...
\begin{ex} \lex{ex:metric_spaces:polish_spaces:0008}
	Let $(X, \MT)$ be a Polish space. Then there exists $B \subset [0,1]^{\N}$ and $f: X \rightarrow B$ such that $B$ is a $G_{\del}$ set and $f$ is a homeomorphism. \\
	\tbf{Hint:} \rex{ex:metric_spaces:metrizable_spaces:0001.001} 
\end{ex}

\begin{proof}
	Define $B \subset [0,1]^{\N}$ and $f: X \rightarrow B$ as in \rex{ex:metric_spaces:metrizable_spaces:0001.001}. Then $f$ is a homeomorphism. Since $X$ is a polish space, \rex{ex:metric_spaces:polish_spaces:0004} implies that $B$ is a Polish space. \rex{ex:metric_spaces:polish_spaces:0006} implies that $B$ is a $G_{\del}$-set. 
\end{proof}


\begin{ex} \lex{ex:metric_spaces:polish_spaces:0009}
	...
	Then $X_0$ is Polish and zero dimensional and for each $x \in X_0$, $x$ is a condensation point of $X_0$. \\
	\tbf{Hint:} \rex{ex:topology:countability:0012.02}
\end{ex}


\begin{proof}
	Since $X$ is Polish, $X$ is second-countable. \rex{ex:topology:countability:0012.02} implies that $X_0$ is closed and $X_0^c$ is countable. Since $X_0$ is closed and $X$ is Polish, \rex{ex:metric_spaces:polish_spaces:0002} implies that $X_0$ is Polish. Since $X_0 \subset X$ and $X$ is zero-dimensional, \rex{ex:topology:zero_dim:0002} implies that $X_0$ is zero-dimensional. Let $x \in X_0$ and $U \in \MN(x)$. By definition, $x$ is a condensation point of $X$. Thus $U \cap X$ is uncountable. For the sake of contradiction, suppose that $U \cap X_0$ is countable. We note that 
	\begin{align*}
		U \cap X
...
\begin{ex} \tbf{Isosceles Triangle Property:} \\
...
\begin{proof}
	Suppose that $\pi^{\MP}_r(x) \cap \pi^{\MP}_s(y) \neq \varnothing$. Then there exists $z \in X$ such that $z \in \pi^{\MP}_r(x) \cap \pi^{\MP}_s(y)$. Therefore $\pi^{\MP}_r(z) = \pi^{\MP}_r(x)$ and $\pi^{\MP}_s(z) = \pi^{\MP}_s(y)$. Since $r \leq s$, \tcb{the previous exercise} implies that $\pi^{\MP}_r(z) = \pi^{\MP}_r(y)$. Since $\MP$ is decreasing, we have that
	\begin{align*}
		\pi^{\MP}_s(y)
		& \subset \pi^{\MP}_r(y) \\
		& = \pi^{\MP}_r(z) \\
...
\begin{defn}
	...
	Then $\MP$ is said to be \tbf{left-continuous} if for each $x,y \in X$, $A^{\MP}(x,y) \neq \varnothing$ and $\al^{\MP}(x,y) < \infty$ implies that $\al^{\MP}(x,y) \in A^{\MP}(x,y)$
\end{defn}

\begin{defn}
	Let $X$ be a set and $\MP: \N \rightarrow \Part(X)$. For $x,y \in X$, we define the \tbf{left-continuous extension of $\MP$} denoted $\bar{\MP}: \Rgp \rightarrow \Part(X)$, by 
...
\begin{defn}
	Let $X$ be a set and $\MP: \Rgp \rightarrow \Part(X)$. Then $\MP$ is said to be \tbf{ultrametric-equivalent} if 
	\begin{enumerate}
...
\begin{proof}\
	\begin{enumerate}
		...
		\item \tcb{The previous exercise} implies that $\bar{\MP}$ is left continuous.
	\end{enumerate}
	Since $\bar{\MP}$ separates points, collects points, is decreasing and is left continuous, $\bar{\MP}$ is ultrametric-equivalent.
\end{proof}

\begin{ex}
	Let $X$ be a set and $\MP: \Rgp \rightarrow \Part(X)$. Suppose that $\MP$ is ultrametric-equivalent. Then for each $x,y \in X$, if $x \neq y$, then $\al^{\MP}(x,y)$ exists and $A^{\MP}(x,y) = [0, \al^{\MP}(x,y)]$
\end{ex}

\begin{proof}
	Let $x,y \in X$. Suppose that $x \neq y$. Since $\MP$ collects points, there exists $r > 0$ such that $\pi^{\MP}_r(x) = \pi^{\MP}_r(y)$. Hence $A^{\MP}(x,y) \neq \varnothing$. Since $\MP$ separates points, there exists $r > 0$ such that $\pi^{\MP}_r(x) \neq \pi^{\MP}_r(y)$. \tcr{A previous exercise} implies that $A^{\MP}(x,y) \subset [0, r)$. Since $A^{\MP}(x,y)$ is nonempty and bounded above, $\al^{\MP}(x,y)$ exists and $\al^{\MP}(x,y) < \infty$. By definition of the supremum, $A^{\MP}(x,y) \subset [0, \al^{\MP}(x,y)]$. Since $\MP$ is left-continuous, $\al^{\MP}(x,y) \in A^{\MP}(x,y)$. \tcr{A previous exercise} implies that $[0, \al^{\MP}(x,y)] \subset A^{\MP}(x,y)$. Hence $A^{\MP}(x,y) = [0, \al^{\MP}(x,y)]$.
\end{proof}
...
\begin{proof}
	...
	\begin{enumerate}
		...
		Suppose that $d^{\MP}(x,y) \leq d^{\MP}(y,z)$. Then $\al^{\MP}(y,z) \leq \al^{\MP}(x,y)$. \tcr{The previous exercises} imply that $\al^{\MP}(y,z) \in A^{\MP}(x,y) \cap A^{\MP}(y,z)$. Hence
		\begin{align*}
			\pi^{\MP}_{\al^{\MP}(y,z)}(x) 
			& = \pi^{\MP}_{\al^{\MP}(y,z)}(y) \\
			& = \pi^{\MP}_{\al^{\MP}(y,z)}(z)
...
\begin{proof}\
	\begin{enumerate}
		...
		\item Let $r,s \in \Rgp$. Suppose that $r \leq s$. Then $s^{-1} \leq r^{-1}$. Let $x \in X$. Choose $\MF_x = \pi^{\MP^d}_r(x)$. Let $y \in \MF_x$. By definition of $\MP^d$ and \tcr{a previous exercise},  
		\begin{align*}
			\pi^{\MP^d}_r(x) 
			& = \pi^d_{r^{-1}}(x) \\
			& = \bar{B}(x, r^{-1})
...
\subsection{Zero-dimensional Ultrametric Spaces}
...
\end{proof}
	...
	\begin{defn} \ld{55001}\
		Let $X$ be a topological vector space over $\K$. We define the \tbf{dual space of} $X$, denoted $X^*$, by $X^* = \{ T : X \rightarrow \K: T \text{ is linear and continuous} \} $
	\end{defn}
...
\end{proof}
	...
	\begin{defn}
		...
		\begin{itemize}
			\item We define the \tbf{canonical pairing of $X$ with $X^*$}, denoted $\l \cdot, \cdot \r: X \times X^* \rightarrow \C$, by $\l x, \phi \r = \phi(x)$. 
	...
	\begin{defn}
		Let $X$ be a topological vector space. We define the \tbf{weak topology on $X$}, denoted $\MT_w$, by $\MT_w = \tau_X(X^*)$.
	\end{defn}
	...
	\begin{defn}
		Let $X$ be a topological vector space. We define the \tbf{weak-* topology on $X^*$}, denoted $\MT_{w*}$, by $\MT_{w*} = \tau_X(\hat{X})$. 
	\end{defn}
...
\end{proof}
	...
	\begin{defn} \ld{def:hilbert:intro:00001}
		...
		\begin{itemize}
			\item $\l \cdot, \cdot \r$ is said to be an \tbf{inner product} on $H$ if for each $x,y,z \in H$ and $c \in \C$
			\begin{enumerate}
...
Let $(H, \l \cdot, \cdot \r)$ be an inner product space. Define the \tbf{induced norm}, denoted $\|\cdot \|: \rightarrow \C$, by $$\|x\| = \l x, x\r^{\frac{1}{2}}$$
\end{defn}
...
\begin{proof}\
	\begin{itemize}
		...
		$$\l x, y \r \defeq \frac{1}{4} \bigg[  \|x+y\|^2 - \|x-y\|^2 - i\|x+iy\|^2 + \|x-iy\|^2 \bigg].$$
	\end{itemize}
	Let $x,y,z \in X$ and $\lam \in \C$. Then 
	\begin{enumerate}
		\item 
		\begin{itemize}
...
\begin{defn} \ld{def:hilbert:intro:00023}
...
\begin{defn} \tbf{Unitary Maps:}
	Let $H_1, H_2 \in \Obj(\Hilb)$ and $U \in L(H_1, H_2)$. Then $U$ is said to be \tbf{unitary} if for each $x,y \in H_1$, $\l Ux, Uy \r = \l x, y \r $.  
\end{defn}

\begin{ex}
	Let $H_1, H_2 \in \Obj(\Hilb)$ and $U \in L(H_1, H_2)$. Then $U$ is unitary iff $U$ is an isometry. \tcr{reprove using parallelogram law}
\end{ex}

\begin{proof}\
	\begin{itemize}
		\item $(\implies)$: \\ 
		Suppose that $U$ is unitary. Let $x \in H_1$. Then 
		\begin{align*}
			\|Ux\|^2 
			& = \l Ux, Ux \r \\
			& = \l x, x \r \\
		...
		\item $(\impliedby)$: \\
		Suppose that $U$ is an isometry. Let $x,y \in H_1$. \rex{ex:banach:bounded_ops:0003} implies that 
		\begin{align*}
			\|x\|^2 + \|y\|^2 - 2 \Re \l x, y \r 
			& = \|x - y\|^2 \\
			& = \|U(x-y)\|^2 \\
			& = \|Ux - Uy\|^2 \\
			& = \|Ux\|^2 + \|Uy\|^2 - 2 \Re \l Ux, Uy \r \\
			& = \|x\|^2 + \|y\|^2 - 2 \Re \l Ux, Uy \r.
		\end{align*}
		Thus $\Re \l Ux, Uy \r = \Re \l x, y \r$. Similarly, 
		\begin{align*}
			\|x\|^2 + \|y\|^2 + 2 \Im \l x, y \r
			& = \|x + iy\|^2 \\ 
			& = \|U(x + iy)\|^2 \\
			& = \|Ux + iUy\|^2 \\
			& = \|Ux\|^2 + \|Uy\|^2 + 2 \Im \l Ux, Uy \r \\
			& = \|x\|^2 + \|y\|^2 + 2 \Im \l Ux, Uy \r.
		\end{align*}
		Thus $\Im \l Ux, Uy \r = \Im \l x, y \r$. Hence $\l Ux, Uy \r = \l x, y \r$. Since $x,y \in H_1$ are arbitrary, we have that for each $x,y \in H_1$, $\l Ux, Uy \r = \l x, y \r$. Thus $U$ is unitary. 
	\end{itemize}
\end{proof}
...
\newpage
	...
	\begin{ex}
		Let $H_1, \ldots, H_n \in \Obj(\Hilb)$, $\phi \in L^n(H_1, \ldots, H_n; \C)$. Suppose that for each $j \in [n]$, $H_j$ is separable. For each $j \in [n]$, let $B_j B_j' \subset H_j$ be an orthonormal basis for $H_j$. Then
	...
	\begin{defn}
		Let $H_1, \ldots, H_n \in \Obj(\Hilb)$, $\phi \in L^n(H_1, \ldots, H_n; \C)$. Suppose that for each $j \in [n]$, $H_j$ is separable. For each $j \in [n]$, let $B_j B_j' \subset H_j$ be an orthonormal basis for $H_j$. We define $\|\cdot\|_{HS}: L^n(H_1, \ldots, H_n; \C) \RG$ by 
		$$\| \phi \|_{HS} \defeq \sum_{e^1 \in B_1} \sum_{e_1 \in B_1} \cdots \sum_{e_n \in B_n} |\phi(e_1, \ldots, e_n)|^2.$$ 
	\end{defn}
