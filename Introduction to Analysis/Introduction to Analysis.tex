...
\end{align*}	
	...
	\begin{ex} \lex{def:continuous_maps:0003}
...
\end{align*}	
	...
	\begin{defn} \ld{def:nets:0024}
		Let $X$ be a topological space, $(x_{\al})_{\al \in A} \subset X$ a net and $x \in X$. Then $x$ is said to be a \tbf{cluster point of} $(x_{\al})_{\al \in A}$ if for each $U \in \MN(x)$, $(x_{\al})_{\al \in A}$ is frequently in $U$.
	\end{defn}
...
\end{proof}
	...
	\begin{defn} \ld{def:product_topology:0008}  
	...
	\begin{ex}  \lex{ex:product_topology:0009}
...
%			Since $x \in \pi^{-1}(\pi(U))$ is arbitrary, we have that for each $x \in \pi^{-1}(\pi(U))$, there exists $U' \in \MT$ such that $x \in U'$ and $U' \subset \pi^{-1}(\pi(U))$. Hence $\pi^{-1}(\pi(U)) \in \MT$. Since $U \in \MT$ is arbitrary, we have that for each $U \in \MT$, $\pi^{-1}(\pi(U)) \in \MT$. Since $\pi: X \rightarrow X / \sim_0$ is a quotient map, 
	...
	\begin{ex} \rex{ex:topology:countability:0002}
	...
	\begin{ex} \rex{ex:topology:countability:0003}
	...
	\begin{ex} \rex{ex:topology:countability:0004}
	...
	\begin{ex} \rex{ex:topology:countability:0006}
	...
	\begin{ex} \rex{ex:topology:countability:0007}
	...
	\begin{ex} \rex{ex:topology:countability:0008}
	...
	\begin{ex} \rex{ex:topology:countability:0012}
	...
	\begin{ex} \tbf{Tychonoff's Theorem:} \\
...
\begin{defn} \ld{def:metric_spaces:introduction:0004}
...
\end{ex}
	...
	\begin{ex} \lex{ex:metric_spaces:introduction:0007}
...
\begin{defn} \ld{def:metric_spaces:introduction:0008}
	Let $(X, d)$ be a metric space, $A \subset X$ and $x \in X$. We define \tbf{the distance between $A$ and $x$}, denoted $d(x, A)$, by 
	$$d(x, A) = \inf \{d(x, a): a \in A\}$$
\end{defn}

\begin{ex} \lex{ex:metric_spaces:introduction:0009}
	Let $(X, d)$ be a metric space, $A \subset X$. Then 
	\begin{enumerate}
		\item for each $x,y \in X$, $|d(x, A) - d(y, A)| \leq d(x, y)$,
		\item $d(\cdot, A)$ is uniformly continuous.
	\end{enumerate}
\end{ex}

\begin{proof}\
	\begin{enumerate}
		\item Let $x,y \in X$. Let $\ep > 0$. Then there exists $a \in A$ such that $d(y, a) < d(y, A) + \ep$. The triangle inequality implies that
		\begin{align*}
			d(x, A) 
			& \leq d(x, a) \\
			& \leq d(x, y) + d(y, a) \\
		...
		\item Let $\ep > 0$. Choose $\del = \ep$. Let $x, y \in X$. Suppose that $d(x,y) < \del$. Then 
		\begin{align*}
			|d(y, A) - d(x, A)|
			& \leq d(x,y) \\
			& < \del \\
...
\begin{ex} \lex{ex:metric_spaces:introduction:0010}
...
\begin{defn} \ld{def:metric_spaces:introduction:0011}
...
\begin{defn} \ld{def:metric_spaces:introduction:0013}
...
\begin{ex}
	Let $(X, d)$ be a metric space. Then 
	\begin{enumerate}
		\item $(X, \MT_d)$ is second countable,  
		\item $(X, \MT_d)$ is separable.
	\end{enumerate}
\end{ex}
...
\begin{proof}
	\begin{enumerate}
		\item 
		\item \rex{ex:topology:countability:00010}.
	\end{enumerate}
...
\begin{defn} \ld{def:metric_spaces:product_spaces:0001}
	Let $(X_n, d_n)_{n \in \N}$ be a collection of metric spaces. Set $X \defeq \prod\limits_{n \in \N} X_n$ and $\MT \defeq \bigotimes\limits_{n \in \N} \MT_{d_n}$. Define $\phi:\Rg \rightarrow [0,1)$ by $\phi(t) \defeq t/(1 + t)$. We define the \tbf{product metric on $X$}, denoted $d_X: X \times X \rightarrow \Rg$ by 
...
\begin{defn} \ld{def:metric_spaces:completeness:0003}
...
\begin{defn} \ld{def:metric_spaces:metrizable_spaces:0001}
	Let $(X, \MT)$ be a topological space. Then $(X, \MT)$ is said to be \tbf{completely metrizable} if there exists a metric $d:X \times X \rightarrow \Rg$ such that $\MT = \MT_d$.
\end{defn}
...
\begin{proof}
	Define $\phi: \Rg \rightarrow \Rg$, $X$ and $\MT$ as in \rd{def:metric_spaces:product_spaces:0001}. Since for each $n \in \N$, $(X_n, \MT_n)$ is completely metrizable, for each $n \in \N$, there exists a metrix $d_n:X_n \times X_n \rightarrow \Rg$ such that $(X_n, d_n)$ is a complete metric space. \rex{ex:metric_spaces:completeness:0006} implies that $(X, d_X)$ is complete. Since $\MT = \MT_{d_X}$, we have that $(X, \MT)$ is completely metrizable. 
\end{proof}
...
\begin{ex}
	Let $(X, \MT)$ be a Polish space and $C \subset X$. If $C$ is closed, then $(C, \MT \cap C)$ is a Polish space.
\end{ex}

\begin{proof}
	Suppose that $C$ is closed. 
	\begin{enumerate}
		\item Since $(X, \MT)$ is completely metrizable, there exists metric $d$ on $X$ such that $(X, d)$ is complete. \rex{ex:metric_spaces:completeness:0004} implies that $(C, d|_{C \times C})$ is complete.
		\item Since $(X, \MT)$ is separable, \tbf{an exercise in the section on separable metric spaces} implies that $(C, \MT \cap C)$ is separable.
	\end{enumerate}
	\tcr{FINISH!!!}
\end{proof}

\begin{ex}
	Let $(X_n, \MT_n)_{n \in \N}$ be a collection of Polish spaces. Then $(\prod\limits_{n \in \N} X_n, \bigotimes\limits_{n \in \N} \MT_n)$ is Polish.  
\end{ex}
...
\begin{proof}\
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item \rex{ex:metric_spaces:introduction:0009} and \rex{ex:metric_spaces:introduction:0010} imply that $f$ is continous. Since $\prj_1:X \times \R \rightarrow X$ is continuous, $f^{-1} = \prj_1|_C$ is continuous. Hence $f$ is a homeomorphism. 
		\end{itemize}
