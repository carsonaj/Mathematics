...
Conversely, suppose that for each $x \in X$, $f$ is continuous at $x$. Let $B \in \MB$. Let $x \in f^{-1}(B)$. Then $B \in \MN_{f(x)}$. Continuity at $x$ implies that $f^{-1}(B) \in \MN_x$. Then $x \in (f^{-1}(B))^{\circ}$. Since $x \in f^{-1}(B)$ is arbitrary, $f^{-1}(B) \subset (f^{-1}(B))^{\circ}$. Hence $f^{-1}(B) = (f^{-1}(B))^{\circ}$ which implies that $f^{-1}(B) \in \MA$. So $f$ is continuous.
	...
	\begin{align*}
	\tau_X(\MF) 
	&= \{f_{\al}^{-1}(B): B \in \MB_{\al} \text{ and } \al \in A \}
\end{align*}	 
	\end{defn}
	...
	\begin{ex}
	Let $X$ be a set, $(Y_{\al}, \MB_{\al})_{\al \in A}$ a collection of topological spaces and $\MF = (f_{\al})_{\al \in A} \in \prod \limits_{\al \in A}Y_{\al}^X$. Then $\tau_X(\MF)$ is a topology on $X$.
	\end{ex}
	...
	\begin{align*}
	\tau_Y(\MF) 
	&= \{V \subset Y: \text{ for each $\al \in A$, $f_{\al}^{-1}(V) \in \MA_{\al}$}\}
\end{align*}	 
	\end{defn}
	...
	\begin{ex}
	Let $(X_{\al}, \MA_{\al})_{\al \in A}$ be a a collection of topological spaces, $Y$ a set and $\MF = (f_{\al})_{\al \in A} \in \prod \limits_{\al \in A}Y^{X_{\al}}$. Then $\tau_X(\MF)$ is a topology on $X$.
	\end{ex}
...
Then $V_{\ep}^o \in \MN_{x_0}$ is open and 
	...
	\begin{ex}
		Let $X$ be a topological vector space and $A$, $B \subset X$ convex. If $A$ is open, then $A - B$ is open.
	\end{ex}
	...
	\begin{ex}
		Let $X$, $Y$ be a topological vector spaces and $\phi:X \rightarrow Y$. Suppose that $\phi$ is linear. Then $\phi$ is continuous iff $\phi$ is continuous at $0$.
	\end{ex}
...
\begin{ex}
	Let $X$ be a topological vector space and $\phi :X \rightarrow \C$ linear. Then $\phi$ is continuous iff $|\phi|$ is continuous. 
\end{ex}
...
%	\begin{ex}
%		Let $X$ be a topological vector space and $(\lam_{\al})_{\al \in A} \subset \C$ and $(x_{\al})_{\al \in A} \subset X$ nets. If $(\lam_{\al})_{\al \in A}$ is bounded and $x_{\al} \rightarrow 0$, then $\lam_{\al}x_{\al} \rightarrow 0$.
%	\end{ex}
%
%	\begin{proof}
%		Suppose that $(\lam_{\al})_{\al \in A}$ is bounded and $x_{\al} \rightarrow 0$. 
%	\end{proof}
	...
	\begin{ex}
		Let $X$ be a vector space and $A$, $B \subset X$ convex. Then $A - B$ is convex.
	\end{ex}
	
	\begin{proof}
		Let $x,y \in A - B$ and $t \in [0,1]$. Then there exist $a_x, a_y \in A$, $b_x, b_y \in B$ such that $x = a_x - b_x$ and $y = a_y - b_y$. Since $A$ and $B$ are convex, $ta_x + (1-t)a_y \in A$ and $tb_x + (1-t)b_y \in B$. Hence 
		\begin{align*}
			tx + (1-t)y
	...
	\begin{ex}
		Let $X$ be a real topological vector space, $A \subset X$ and $x_0 \in A^c$. Suppose that $A$ is convex, $A \in \MN_0$ and $A$ is open. Then there exists $F \in X^*$ such that $F(x_0) =1$ and $F|_A < 1$. \\
		\textbf{Hint:} 
		\begin{enumerate}
	...
	\begin{proof}\
		\begin{enumerate}
			\item Define $f \in (\R x_0)^*$ by $f(tx_0) = t$. Then $f(x_0) = 1$. Since $A \in \MN_0$, $0 \in A$ and a previous exercise implies that $A$ is absorbing. Since $A$ is convex, absorbing and $0 \in A$, $p_A:X \rightarrow [0, \infty)$ is a sublinear functional on $X$. Since $x_0 \in A^c$, the previous exercise implies that $1 \leq p_A(x_0)$. Let $y \in \R x_0$. Then there exists $t \in \R$ such that $y = tx_0$. 
			\begin{itemize}
				...
				\end{align*}
			\end{itemize}
				So $f \leq p_A$ on $\R x_0$. The Hahn-Banach theorem implies that there exists $F \in X^*$ such that $F|_{\R x_0} = f$ and $F \leq p_A$. The previous exercise implies that  $p_A|_A < 1$. Hence $F|_A < 1$. 
	...
	\begin{ex} \textbf{Geometric Hahn-Banach Theorem 1:} \\
		Let $X$ be a real topological vector space and $A$, $B \subset X$. Suppose that $A$, $B$ are nonempty, convex and disjoint. If $A$ is open, then there exists $\phi \in X^*$ and $c \in \R$ such that for each $x \in A$, $y \in B$, $$\phi(x) < c \leq \phi(y)$$
		\textbf{Hint:}
		\begin{enumerate}
	...
	\begin{ex}
		Let $X$ be a locally convex space. Then X is a topological vector space.
	\end{ex}
	
	\begin{proof}\
		\begin{enumerate}
			\item Let $(x_{\al})_{\al \in A}$, $(x_{\al})_{\al \in A} \subset X$ and $(\lam_{\al})_{\al \in A} \subset \C$ be nets and $x$,$y \in X$, $\lam \in \C$. Suppose that $x_{\al} \rightarrow x$, $y_{\al} \rightarrow y$ and $\lam_{\al} \rightarrow \lam$. Then 
			\begin{align*}
				p([x_{\al} + y_{\al}] - [x + y]) 
				&= p([x_{\al} - x] + [y_{\al} - y]) \\
				...
				& \rightarrow 0
			\end{align*}
			So addition $X \times X \rightarrow X$ is continuous. \\
	...
	\begin{defn} \ld{55002}\
		Let $X$ be a locally convex space over $\C$. We define the \textbf{dual space of} $X$, denoted $X^*$, by $X^* = \{\phi:X \rightarrow \C: \phi \text{ is linear and continuous}\}$.
	\end{defn}
	
	\begin{note}
		We define $X^*$ similarly when $X$ is a locally convex space over $\R$.
	\end{note}
	
	\begin{ex}
		Let $X$ be a locally convex space and $U \in \MN_0$ open. Then for each $p \in \MP$, there exists $r >0$ such that $B_p(0,r) \subset U$.
	\end{ex}

	\begin{proof}
		For the sake of contradiction, suppose that there exists $p \in \MP$ such that for each $r >0$, $B_p(0,r) \not \subset U$. Then there exists a sequence $(x_n)_{n \in \N} \subset U^c$ such that for each $n \in \N$, $p(x_n) < 1/n$. So $x_n \rightarrow 0$. Since $U^c$ is closed, $0 \in U^c$ which is a contradiction. Hence each $p \in \MP$, there exists $r >0$ such that $B_p(0,r) \subset U$.
	\end{proof}
	...
	\begin{proof}
		Set $p_f = |f|$. Since $p_f$ is a continuous seminorm, $B_{p_f}(0,1)$ is open in $M$. Therefore, there exists $U \subset X$ open such that $B_{p_f}(0,1) = U \cap M$. Since $\MP \neq \varnothing$, there exists $p \in \MP$. A previous exercise implies that there exists $r >0$ such that $B_p(0, r) \subset U$. Set $A = B_p(0, r)$. Since $A$ is open, $p_A:X \rightarrow \Rg$ is continuous and $A = B_{p_A}(0,1)$. Hence 
		\begin{align*}
			B_{p_A|_M}(0,1) 
...
\begin{defn}
Let $X$ be a normed vector space. We define the \textbf{weak topology on $X$}, denoted $\MT_w$, by $\MT_w = \tau_X(X^*)$ (i.e. the initial topology on $X$ generated by $X^*$).
\end{defn}

\begin{defn}
Let $X$ be a normed vector space, $(x_{\al})_{\al \in A} \subset X$ and $x \in X$. Then $(x_{\al})_{\al \in A}$ is said to \textbf{converge weakly to $x$}, denoted $x_{\al} \conv{w} x$ if $(x_{\al})_{\al \in A}$ converges to $x$ in the weak topology.
\end{defn}

\begin{ex} \lex{}
Let $X$ be a normed vector, $(x_{\al})_{\al \in A} \subset X$ a net and $x \in X$. Then $x_{\al} \conv{w} x$ iff for each $\lam \in X^*$, $ \lam (x_{\al}) \rightarrow \lam(x)$. 
\end{ex}
...
\begin{defn}
Let $X$ be a normed vector space. We define the \textbf{weak-* topology on $X^*$}, denoted $\MT_{w*}$, by $\MT_{w*} = \tau_X(\hat{X})$ (i.e. the initial topology on $X^*$ generated by $\hat{X}$). 
\end{defn}

\begin{defn}
	Let $X$ be a normed vector space, $(\lam_{\al})_{\al \in A} \subset X^*$ and $\lam \in X^*$. Then $(\lam_{\al})_{\al \in A}$ is said to \textbf{converge in weak-* to $\lam$}, denoted $\lam_{\al} \conv{w^*} \lam$ if $(\lam_{\al})_{\al \in A}$ converges to $\lam$ in the weak-* topology.
\end{defn}

\begin{ex} \lex{}
	Let $X$ be a normed vector, $(\lam_{\al})_{\al \in A} \subset X^*$ a net and $\lam \in X^*$. Then $\lam_{\al} \conv{w^*} \lam$ iff for each $x \in X$, $ \lam_{\al} (x) \rightarrow \lam(x)$. 
\end{ex}
...
\end{proof}
	...
	\begin{ex}
		...
		\begin{enumerate}
			\item $(X, \MT_w)$ is a locally convex space 
	...
	\begin{proof}\
		\begin{enumerate}
			\item For $\lam \in X^*$, define $p_{\lam}:X \rightarrow \Rg$ by $p_{\lam} = |\lam|$. Set $\MP_{w} = \{p_{\lam}: \lam \in X^*\}$. Let $(x_{\al})_{\al \in A} \subset X$ be a net and $x \in X$. Suppose that $x_{\al} \conv{w} x$. Let $\lam \in X^*$. Then 
			\begin{align*}
				p_{\lam}(x_{\al} - x) 
				&= |\lam(x_{\al} - x)| \\
				&= |\lam(x_{\al}) - \lam(x)| \\
			...
			\item For $x \in X$, define $p_x:X^* \rightarrow \Rg$ by $p_x = |\hat{x}|$. Set $\MP_{w^*} = \{p_x:x \in X\}$. Let $(\lam_{\al})_{\al \in A} \subset X^*$ be a net and $\lam \in X^*$. Suppose that $\lam_{\al} \conv{w^*} \lam$. Let $x \in X$. Then 
			\begin{align*}
				p_x(\lam_{\al} - \lam) 
				&= |\hat{x}(\lam_{\al} - \lam)| \\
...
\newpage
	...
	Let $X$ be a normed vector space, $M \subset X$ and $N \subset X^*$. Then 
	\begin{enumerate}
	\item $^{\perp}(M^{\perp}) = \bar{M}$, i.e. the norm closure of $M$
	...
	\begin{proof}\
	\begin{enumerate}
	\item Let $x \in M$, then by definition, for each $\phi \in M^{\perp}$, $\phi(x) = 0$. Again by definition, $x \in {^{\perp}(M^{\perp})}$. So $M \subset {^{\perp}(M^{\perp})}$. Since ${^{\perp}(M^{\perp})}$ is closed, $\bar{M} \subset {^{\perp}(M^{\perp})}$. For the sake of contradiction, suppose that ${^{\perp}(M^{\perp})} \not \subset \bar{M}$. Then there exists $x \in {^{\perp}(M^{\perp})}$ such that $x \not \in \bar{M}$. \rex{55017} implies that there exists $\phi \in X^*$ such that $\phi|_{\bar{M}} = 0$, $\|\phi\| = 1$ and $\phi(x) = \|x + \bar{M}\| > 0$. By definition, $\phi \in M^{\perp}$. Since $\phi(x) \neq 0$, we have that $x \not \in {^{\perp}(M^{\perp})}$. This is a contradiction and so ${^{\perp}(M^{\perp})} \subset \bar{M}$.
	\item 
	\end{enumerate}
	\end{proof}
...
\end{enumerate}	 
	...
	\begin{ex}
		...
		\end{enumerate}
	\textbf{Hint:} Hahn Banach separation theorem \\
	\end{ex}

	\begin{proof}\
		\begin{enumerate}
			\item Suppose that $x_0 \in A$. Let $\ep >0$. Since $f$ is convex and lower semicontinuous, $\epi f \subset X \times \R$ is convex and closed and $\{(x_0, f(x_0) - \ep)\} \subset X \times \R$ is convex and compact. Thus, there exists $\lam \in \R$, $\psi \in X^*$ and $k \in \R$ such that for each $x \in A$ and $r \geq f(x)$, 
