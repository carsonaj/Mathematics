...
\begin{document}
	...
	We define $\pi_{\Re}, \pi_{\Im}: \C \rightarrow \R$ by $\pi_{\Re}(a + ib) = a$ and $\pi_{\Im}(a+ib) = b$.
...
\end{align*}	
	...
	\begin{ex} \tbf{Topology in Terms of Nets: } \lex{33009.1}\\
...
\end{align*}	
	...
	\begin{proof}\
		\begin{itemize}
			...
			\end{align*}
			we have that for each $\al \in A$, $[\Int U] \cap \cl E_{\al} \neq \varnothing$. \rex{33009.2} implies that for each $\al \in A$,
			\begin{align*}
				\varnothing 
				& \neq [\Int U] \cap E_{\al} \\
				& \subset U \cap E_{\al}
...
\end{proof}
	...
	\begin{ex}
		Let $X$ be a topological vector space and $\phi \in X^*$. Then $\pi_{\Re} \circ \phi$ is continuous and real-linear. 
	\end{ex}
	...
	\begin{ex}
		Let $X$ be a topological vector space and $f:X \rightarrow \R$. If $f$ is continuous and real-linear, then there exists a unique $\phi \in X^*$ such that $\pi_{\Re} \circ \phi = f$. \\
	...
	\begin{proof}
		...
		\begin{align*}
			...
			&= \phi(x) + \lam \phi(y) 
		\end{align*}
	So $\phi$ is linear and $\phi \in X^*$. Let $\psi \in X^*$. Suppose that $f = \pi_{\Re} \circ \psi$. 
	Then for each $x \in X$,
	\begin{align*}
		\phi(x) 
		&= f(x) - if(ix) \\
		&= \pi_{\Re}[ \psi(x)] -i \pi_{\Re}[ \psi(ix)] \\
		&= \pi_{\Re} [\psi(x)] - \pi_{\Re} [i\psi(x)] \\
		&= \pi_{\Re} [\psi(x)] + \pi_{\Im}[ \psi(x)] \\
		&= \psi(x)
	\end{align*} 
	...
	\begin{ex}
		Let $X$ be a topological vector space, $A \subset X$ and $x_0 \in A^c$. Suppose that $A$ is convex, $A \in \MN(0)$ and $A$ is open. Then there exists $F \in X^*$ such that $\pi_{\Re} \circ F(x_0) =1$ and $\pi_{\Re} \circ F|_A < 1$. \\
	...
	\begin{proof} Assume that $X$ is real.
		...
		\end{enumerate}
	If $X$ is complex, then the previous part implies that there exists $G:X \rightarrow \R$ such that $G$ is continuous, real-linear, $G(x_0) = 1$ and $G|_A < 1$. A previous exercise implies that there exists a unique $F \in X^*$ such that $\pi_{\Re} \circ F = G$.
	\end{proof}

	\begin{ex} \tbf{Hahn-Banach Separation Theorem 1:} \\
		Let $X$ be a topological vector space and $A$, $B \subset X$. Suppose that $A$, $B$ are nonempty, convex and disjoint. If $A$ is open, then there exists $\phi \in X^*$ and $c \in \R$ such that for each $x \in A$, $y \in B$, $$\pi_{\Re} \circ \phi(x) < c \leq \pi_{\Re} \circ \phi(y)$$
		\tbf{Hint:} Assume $X$ is real.
		\begin{enumerate}
	...
	$$f(x) < c \leq f(y)$$ 
	A previous exercise implies that there exists a unique $\phi \in X^*$ such that $\pi_{\Re} \circ \phi = f$.
	\end{proof}
	...
	\begin{ex} \tbf{Hahn-Banach Separation Theorem 2:}\\
		Let $X$ be a locally convex space and $A$, $B \subset X$. Suppose that $A$, $B$ are nonempty, convex and disjoint. If $A$ is compact and $B$ is closed, then there exists $\phi \in X^*$ and $c_1, c_2 \in \R$ such that for each $x \in A$, $y \in B$, $$\pi_{\Re} \circ \phi(x) < c_1 < c_2 \leq \pi_{\Re} \circ \phi(y)$$
...
& \leq f(t) \\
&=  \|x - tz\|^2 \\
&= \|x\|^2 + |t|^2\|z\|^2 - 2 \pi_{\Re}(t \l x,z \r) \\
