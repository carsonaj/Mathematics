...
\end{align*}	
	...
	\begin{defn}
	Let $(X_{\al})_{\al \in A}$ be a collection of topological spaces. We define the \textbf{product topology} on $\prod_{\al \in A}X_{\al}$ to be the weak topology generated by $(\pi_{\al})_{\al \in A}$.
	\end{defn}
