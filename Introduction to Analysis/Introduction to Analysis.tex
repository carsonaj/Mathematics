...
\end{proof}		
	...
	\begin{note}
	This section assumes familiarity with the algebraic tensor product of two vector spaces. See section ??? of \cite{???} for details. 
	\end{note}	
...
\end{tikzcd}
	...
	\begin{defn}
	Let $X$ and $Y$ be Banach spaces. Define $X \otimes^{\text{alg}} Y = \spn \{ x \otimes y: x \in X \text{ and } y \in Y \}$ to be the algebraic tensor product of $X$ with $Y$ (see section ??? of \cite[?] for details). 
	\end{defn}
	...
	\item Let $u \in X \otimes^{\text{alg}} Y$. Suppose that $\|u\| = 0$. \\
	\textbf{FINISH!!!}
	\end{itemize}
	\end{proof}
	
	\begin{ex} \textbf{Existence:} \\
	Let $X$ and $Y$ be Banach spaces. Then $X \otimes Y$ exists.\\
	\textbf{Hint:} For $x \in X$ and $y \in Y$, define $x \otimes y \in L(L^2(X,Y;\C)^*, \C)$ by $x \otimes y( T) = T(x,y)$.
	\end{ex}
	
	\begin{proof}
	For $x \in X$ and $y \in Y$, define $x \otimes y \in L(L^2(X,Y;\C)^*, \C)$ by $x \otimes y( T) = T(x,y)$. Set $X \otimes^{\text{alg}} Y = \spn \{ x \otimes y: x \in X \text{ and } y \in Y \}$
	\end{proof}	
