...
\end{proof}
	...
	\begin{ex}  \lex{ex:product_topology:0005}
...
\begin{defn} \ld{def:metric_spaces:introduction:0021}
	Let $X$ be a topological space and $A \subset X$. Then 
	\begin{itemize}
...
\begin{note}
	\tcb{An exercise in introduction section} implies that $P_E$ is well-defined. \tcr{explain how this relates to quotient}
\end{note}
...
\begin{ex} \tbf{Gelfand-Mazur Theorem:} \\
...
\end{note}
	...
	\begin{defn}
		...
		\begin{itemize}
			\item \tbf{proper} if $J \neq X$,
			\item \tbf{maximal} if $J$ is proper and for each $J' \subset X$, $J'$ is an ideal of $X$ and $J \subset J'$ implies that $J = J'$ or $J' = X$.
		\end{itemize}
	\end{defn}
	...
	\begin{proof}\
		\begin{enumerate}
			\item \tcr{A previous exercise} \rex{} implies that $\cl J$ is an ideal of $X$. Since $J$ is proper, \tcr{the previous exercise} \rex{} implies that $J \subset G(X)^c$. \tcr{A previous exercise} implies that $G(X)^c$ is closed. Hence $\cl J \subset G(X)^c$. \tcr{The previous exercise} \rex{} then implies that $\cl J$ is proper.
			\item \tcr{zorn's lemma FINISH!!!}
			\item Suppose that $J$ is maximal. Since $J \subset \cl J$ and $J$ is maximal, we have that $J = \cl J$ or $\cl J = X$. Since $J$ is maximal, $J$ is proper. \tcr{the previous part} implies that $\cl J$ is proper. Thus $\cl J \neq X$. Hence $J = \cl J$.
		\end{enumerate}
	\end{proof}
	...
	\begin{ex}
		Let $X$ be a unital Banach algebra and $K \subset X/J$ an ideal of $X/J$. Then 
		\begin{enumerate}
			\item $\pi^{-1}(K)$ is an ideal of $X$ and $J \subset \pi^{-1}(K)$,
			\item $J$ is maximal implies that $X/J = \C(e + J)$.
		\end{enumerate}
	\end{ex}
	...
	\begin{proof}\
		\begin{enumerate}
			...
			Let $x \in X$ and $y \in \pi^{-1}(K)$. Then $\pi(y) \in K$. Since $K$ is an ideal of $X/J$, we have that $\pi(x) \pi(y) \in K$. Therefore
			\begin{align*}
				\pi(xy)
				& = \pi(x) \pi(y) \\
				& \in K.
	...
	\begin{ex}
		Let $X$ be a unital Banach algebra.
		\begin{enumerate}
			\item For each $\phi \in \sig(X)$, $\ker \phi$ is a maximal left ideal of $X$. \\
			\tbf{Hint:} Let $J' \subset X$ be an ideal of $X$. Suppose that $\ker \phi \subset J'$ and $\ker \phi \neq J$. Write $e = a + b$ with $a \in \ker \phi$ and $b \in J' \setminus \ker \phi$.
			\item Set $\MJ(X) \defeq \{J \subset X: \text{$J$ is a maximal left ideal of $X$}\}$. Define $\al: \sig(X) \rightarrow \MJ(X)$ by $\al(\phi) = \ker \phi$. Then $\al$ is a bijection.
		\end{enumerate}
	\end{ex}
