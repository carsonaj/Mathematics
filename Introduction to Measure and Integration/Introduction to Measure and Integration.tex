...
\end{align*}		
	...
	\begin{ex} \lex{ex:complex_radon_measures:0002}
		Let $X$ be a topological space and $\nu \in M(X)$. Then $\nu$ is Radon iff $\pi_{\Re} \circ \nu $ is Radon and $\pi_{\Im} \circ \nu$ is Radon.  
	\end{ex}
	...
	\begin{proof}
		...
		\begin{align*}
			\pi_{\Re} \circ (\mu + \lam \nu) 
			& = \pi_{\Re} \circ \mu + \pi_{\Re}(\lam) \pi_{\Re} \circ \nu \\
			& \in M_+(X)
		\end{align*}
		and 
		\begin{align*}
			\pi_{\Im} \circ (\mu + \lam \nu) 
			& = \pi_{\Im} \circ \mu + \pi_{\Im}(\lam) \pi_{\Im} \circ \nu \\
			& \in M_+(X)
		\end{align*}  
		\rex{ex:complex_radon_measures:0002} implies that 
		\begin{align*}
			\mu + \lam \nu 
			& = \pi_{\Re} \circ (\mu + \lam \nu)  + \pi_{\Im} \circ (\mu + \lam \nu) \\
			& \in \MM(X)
		\end{align*}
		\tcr{FINISH!!!}
	\end{proof}
	...
	\begin{ex} \lex{ex:differentiation_complex_measures:0002}
		...
		\begin{enumerate}
			\item $$D_{\mu} \nu = \frac{d\nu_{\mu}}{d \mu}.$$
			\item If $\mu$ is $d$-Vitalu, then for $\mu$-a.e. $x \in X$, 
	...
	\begin{proof}\
		\begin{enumerate}
			...
			\begin{align*}
				...
				& = D_{\mu} (\pi_{\Re} \nu) + i D_{\mu} (\pi_{\Im} \nu) \\
				& = [D_{\mu} (\pi_{\Re} \nu)^+ - D_{\mu} (\pi_{\Re} \nu)^-] + i [D_{\mu} (\pi_{\Im} \nu)^+ - D_{\mu} (\pi_{\Im} \nu)^-] \\
				& = \bigg[ \frac{ d(\pi_{\Re} \nu)^+_{\mu}}{d\mu} - \frac{d (\pi_{\Re} \nu)^-_{\mu}}{d \mu} \bigg] + i \bigg[ \frac{d (\pi_{\Im} \nu)^+_{\mu}}{d \mu} - \frac{d (\pi_{\Im} \nu)^-_{\mu}}{d \mu} \bigg] \\
				& = \frac{d (\pi_{\Re} \nu)_{\mu} }{d \mu} + i \frac{d (\pi_{\Im} \nu)_{\mu}}{d \mu} \\
				& = \frac{d \nu_{\mu}}{d \mu}
			\end{align*}
			\item Suppose that $\mu$ is $d$-Vitali. \rex{ex:diff_radon_measures:0011} implies that for $\mu$-a.e. $x \in X$, 
			\begin{align*}
				D_{\mu} \nu(x)
				& = [D_{\mu} (\pi_{\Re} \nu)^+ - D_{\mu} (\pi_{\Re} \nu)^-] + i [D_{\mu} (\pi_{\Im} \nu)^+ - D_{\mu} (\pi_{\Im} \nu)^-] \\
				& = \lim_{r \rightarrow 0^+} \frac{ (\pi_{\Re} \nu)^+(\bar{B}(x, r))}{\mu(\bar{B}(x, r))} + \lim_{r \rightarrow 0^+} \frac{ (\pi_{\Re} \nu)^-(\bar{B}(x, r))}{\mu(\bar{B}(x, r))} \\
				& \quad \quad \quad \quad  + \lim_{r \rightarrow 0^+} \frac{ (\pi_{\Im} \nu)^+(\bar{B}(x, r))}{\mu(\bar{B}(x, r))} + \lim_{r \rightarrow 0^+} \frac{ (\pi_{\Im} \nu)^- (\bar{B}(x, r))}{\mu(\bar{B}(x, r))} \\
				& = \lim_{r \rightarrow 0^+} \frac{\nu(\bar{B}(x, r))}{\mu(\bar{B}(x, r))}
			\end{align*}
		\end{enumerate}
	\end{proof}
