...
\begin{document}
	...
	\begin{proof}
		Let $A \subset X$.
		\begin{itemize}
			\item  Suppose that $\mu^*(A) = \infty$. Set $B = X$. Then $A \subset B$ and \tcb{ the previous exercise} implies that
			\begin{align*}
				\mu(B)
				& = \mu(X) \\
				& = \mu^*(X) \\
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			\begin{align*}
				...
				& = \nu(A) 
			\end{align*}
			\item Suppose that $\nu_{\mu}(A) < \infty$. \tcb{The previous exercise} implies that for each $n \in \N$, there exists $E_n \in \MA$ such that $E_n \subset A$, $E_n$ $\mu^*$-covers $A$ and $\nu(E_n) < \nu_{\mu}(A) + 1/n$. Define $E \in \MA$ by $E \defeq \bigcap_{j \in \N} E_j$. By construction, $E \subset A$. \tcb{A previous exercise} implies that $E$ $\mu^*$-covers $A$. By definition, $\nu_{\mu}(A) \leq \nu(E)$. Let $n \in \N$. By construction,
			\begin{align*}
				\nu(E)
				& \leq \nu(E_n) \\
				& \leq \nu_{\mu}(A) + 1/n
	...
	\begin{defn} \ld{def:subspace_measures:00001} 
		...
		\begin{itemize}
			...
			$$\mu|_E(A) = \mu(A)$$
			\item We define the \tbf{restriction of $\mu$ to $E$ on $X$}, denoted $\mu_E: \MA \rightarrow \RG$, by 
			$$\mu_E(A) = \mu(A \cap E)$$
		\end{itemize}
	\end{defn}

	\begin{ex} \lex{ex:subspace_measures:00002} 
		Let $(X, \MA)$ be a measurable space, $\mu$ a measure on $(X, \MA)$ and $E \in \MA$. Then $\mu|_E \in M_+(E, \MA \cap E)$. 
	\end{ex}
...
\section{Coproduct Measures}
	...
	\begin{ex} \tcb{Change notation or define categories}
...
\end{align*}		
	...
	\begin{itemize}
		\item Let $E \in \MB(X)$. Then $\mu$ is said to be 
		\begin{enumerate}
	...
	\begin{itemize}
		...
		\end{enumerate}
		\item We define $\MM_+(X) = \{\mu \in M_+(X): \mu \text{ is Radon}\}$.
		\item Let $\mu \in M(X)$. Then $\mu$ is said to be \textbf{Radon} if $|\mu|$ is Radon.
		\item We define $\MM(X) = \{\mu \in M(X): \mu \text{ is Radon}\}$.
		\item We define $\MM_1(X) = \{\mu \in \MM_+(X) : \mu \text{ is a probability measure}\}$.
	\end{itemize}
	\end{defn}
	...
	\begin{defn}
		...
		\begin{itemize}
			...
			$$\supp \mu \defeq \bigg[ \bigcup_{U \in \MN_{\mu}} U \bigg]^c$$ 
			\item the \tbf{null set of $\mu$}, denoted $N_{\mu}$, by $N_{\mu} \defeq (\supp \mu)^c$
		\end{itemize}
	\end{defn}
	...
	\begin{ex}
		Let $X$ be a topological space and $\mu \in \MM_+(X)$. Let $x \in \supp \mu$. Then for each $U \in \MN(x)$, $\mu(U) > 0$.
	\end{ex}

	\begin{proof}
		Let $U \in \MN(x)$. For the sake of contradiction, suppose that $\mu(U) = 0$. Then $\mu(\Int U) = 0$ and thus $\Int U \in \MN_{\mu}$. Therefore
		\begin{align*}
			x
			& \in \Int U \\
	...
	\begin{ex} \lex{00000} 
		Let $X$ be a topological space, $\mu \in \MM_+(X)$ and $E \in \MB(X)$. If $\mu|_E$ is $\sig$-finite, then $\mu$ is inner regular on $E$. \\
		\textbf{Hint:} use the previous exercise
	\end{ex}
	
	\begin{proof}
		Suppose that $\mu|_E$ is $\sig$-finite. 
		\begin{itemize}
	...
	\begin{proof}
		If $X$ is $\sig$-compact, then $\mu$ is $\sig$-finite. \tcb{The previous exercise} implies that $\mu$ is regular.
	\end{proof}
	...
	\begin{ex}
		Let $X$ be a topological space, $\mu \in \MM_+(X)$ and $E \in \MB(X)$. Then 
		\begin{enumerate}
			\item for each $K \subset E$, $K$ is compact implies that $\mu|_E(K) < \infty$
			\item $\mu|_E$ is outer regular
		\end{enumerate}
	\end{ex}
	...
	\begin{proof}
		...
		\begin{enumerate}
			\item \tcb{The previous exercise} implies that for each $K \subset E$, $K$ is compact implies that $\mu|_E(K) < \infty$.
			\item \tcb{The previous exercise} implies that  $\mu|_E$ is outer regular on $B$.
			\item Let $B \in \MB(E)$.  Set 
	...
	\newpage
	\subsection{Differentiation of Radon Measures on Metric Spaces}
	...
	\begin{defn}
		Let $(X, d)$ be a metric space and $\mu$ a measure on $(X, \MB(X))$. Then $\mu$ is said to be \tbf{$d$-Vitali} if for each $A \subset X$ and $\MV \in \MC(A)$, $\MV$ is fine on $A$ implies that there exists $\MF \subset \MV$ such that 
		\begin{enumerate}
	...
	\begin{defn}
		...
		\begin{itemize}
			\item We define $\bar{D}_{\nu, \mu}: X \rightarrow \RG$ and $\ub{D}_{\nu, \mu}: X \rightarrow \RG$ by 
			\[
			\ol{D}_{\mu}\nu(x) \defeq
			\begin{cases}
			...
			\end{cases}
			\]
			\item If $\ol{D}_{\mu}\nu = \ub{D}_{\mu}\nu$, we define $D_{\mu}\nu: X \rightarrow \RG$ by $D_{\mu}\nu \defeq \ol{D}_{\mu}\nu$.
		\end{itemize}
	\end{defn}
	
	\begin{ex}
		Let $(X, d)$ be a metric space, $\al, \be \in \MM_+(X)$ and $c \in (0,\infty)$. Suppose that $\al, \be$ are $\sig$-finite. Then for each $x \in \supp \al \cup \supp \be$, 
		$\ub{D}_{\al} \be (x) < c$ iff $\ol{D}_{\be}\al(x) > c^{-1}$. 
	\end{ex}

	\begin{proof}
		Let $x \in \supp \al \cup \supp \be$. 
		\begin{itemize}
			\item Suppose that $x \in \supp \al$. \tcb{An exercise in the introduction section on Radon measures} implies that for each $r > 0$, $\al(\bar{B}(x, r)) > 0$. Then $(\al(\bar{B}(x, r))/\be(\bar{B}(x, r)) )_{r > 0} \subset \RG$. 
			\item Similarly, if $x \in \supp \be$, then for each $r > 0$, $\be(\bar{B}(x, r)) > 0$. Then $(\al(\bar{B}(x, r))/\be(\bar{B}(x, r)) )_{r > 0} \subset \RG$. 
		\end{itemize}
		Since the map $\RG \rightarrow \RG$ given by $x \mapsto x^{-1}$ is order reversing, we have that
		\begin{align*}
			\ol{D}_{\be}\al(x) > c^{-1}
	...
	\begin{ex}
		Let $(X, d)$ be a metric space and $\mu, \al, \be \in \MM_+(X)$. Suppose that $\mu$ is $d$-Vitali. Let $c \in (0,\infty)$ and $A \subset X$. 
		\begin{enumerate}
	...
	\begin{proof}\
		\begin{enumerate}
			\item Suppose that $A \subset \{x \in X: \ub{D}_{\al}\be(x) < c\}$. 
			\begin{itemize}
				...
				\begin{align*}
					...
					& = c \be_{\mu}(A)
				\end{align*}
				\item Suppose that $\be_{\mu}(A) < \infty$. Let $\ep >0$. Since $\be_{\mu}(A) < \infty$, $\be_{\mu}(A) < \be_{\mu}(A) + \ep/c$. \tcb{An exercise in the section on Lebesgue decomposition of Radon measures} implies that there exists $U \subset X$ such that $U$ is open, $\mu^*(A \setminus U) = 0$ and $\be(U) < \be_{\mu}(A) + \ep/c$. Define 
				$$\MV_{U} \defeq \{\bar{B}(x, r) \subset U: x \in A \cap U, r > 0 \text{ and } \al( \bar{B}(x, r)) < c \be( \bar{B}(x, r))\}$$
				Let $x \in A \cap U$. Since $\ub{D}_{\be}\al(x) < c$ and $c < \infty$, we have that $x \in \supp \be$. \tcb{A previous exercise in the introduction section on Radon measures} then implies that for each $r > 0$, $\be(\bar{B}(x, r)) > 0$. Since 
				\begin{align*}
			...
			\end{itemize}
			\item Suppose that $A \subset \{x \in X: \ol{D}_{\be}\al(x) > c\}$. \tcb{A previous exercise implies that} for each $x \in \supp \al \cup \supp \be$, $\ub{D}_{\al} \be (x) < c^{-1}$ iff $\ol{D}_{\be}\al(x) > c$. Hence $A \cap \supp \be \subset \{x \in X: \ub{D}_{\al}\be(x) < c^{-1}\}$. Since $\be_{\mu} \leq \be$ \tcr{(show that $\be_{\mu}(A) = \be_{\mu}(A \cap \supp \be)$)}, part $(1)$ implies that
			\begin{align*}
				\be_{\mu}(A)
	...
	\begin{ex}
		Let $(X, d)$ be a metric space and $\mu, \nu \in \MM_+(X)$. Suppose that $\mu$ is $d$-Vitali. Let $c \in (0,\infty)$ and $A \subset X$. If $A \subset \{x \in X: \ub{D}_{\al}\be(x) < c\}$, then $\al_{\mu}(A) \leq c \be_{\mu}(A)$. 
	\end{ex}
	
	\begin{ex}
		Let $(X, d)$ be a metric space and $\mu, \nu \in \MM_+(X)$. Suppose that $\mu, \nu$ are $\sig$-finite. If $\mu$ is $d$-Vitali, then 
		\begin{enumerate}
			\item $0 \leq D_{\mu}\nu < \infty$ $\mu$-a.e.
			\item $D_{\mu}\nu \in L^0(X, \MB(X))$ 
			\item $D_{\mu}\nu = d\nu_{\mu}/ d\mu$ 
	...
	\begin{proof} Suppose that $\mu$ is $d$-Vitali.
		\begin{enumerate}
			\item Define $I = \{x \in X: \ol{D}_{\mu}\nu(x) = \infty\}$. Let $\ep > 0$. Define $c \in (0, \infty)$ by $c \defeq (\nu_{\mu}(I) + 1) / \ep$. Then $I \subset \{x \in X: \ol{D}_{\mu}\nu(x) > c\}$. Therefore \tcr{(need to handle cases when $\nu_{\mu}(I) = \infty$)}
			\begin{align*}
				 \mu_{\mu}(I) 
				 & \leq c^{-1} \nu_{\mu}(I) \\
				 & = \frac{\ep \nu_{\mu}(I)}{\nu_{\mu}(I) + 1} \\
				 & \leq \ep 
			\end{align*}
			Since $\ep > 0$ is arbitrary, $\mu_{\mu}(I) = 0$. Since $\mu \ll \mu$, \rex{ex:lebesgue_decomposition_radon_measures:0005} implies that $\mu_{\mu}|_{\MB(X)} = \mu$. \rex{ex:lebesgue_decomposition_radon_measures:0009} implies that there exists $N \in \MB(X)$ such that $I \subset N$ and $\mu_{\mu}(\mu)(N) = 0$. Thus
			\begin{align*}
				\mu(N)
				& = \mu_{\mu}(N) \\
				& = 0
			\end{align*}
			Since $I = \{x \in X: D_{\mu}\nu(x) = \infty \}$ and there exists $N \in \MB(X)$ such that $I \subset N$ and $\mu(N) = 0$, we have that $D_{\mu}\nu < \infty$ $\mu$-a.e.
			\item 
			\item 
		\end{enumerate}
	\end{proof}
