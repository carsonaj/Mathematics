...
\end{align*}				
	...
	&= \varnothing
	\end{align*}	 
	and since $B_{t_1} \cap  B_{t_2} \subset X_2 = f(X_1)$, we have that 
	\begin{align*}
	B_{t_1} \cap  B_{t_2} 
	& \subset f(f^{-1}(B_{t_1} \cap  B_{t_2} )) \\
	&= f(\varnothing) \\
	&= \varnothing
	\end{align*}
	\item we have that 
	...
	&= X_1
	\end{align*}
	Since $X_2 = f(X_1)$, we have that  $X_2 \subset \bigcup\limits_{t \in g(X_1)} B_t$.\\
	\end{itemize}
	Therefore, 
	\begin{itemize}
