...
\end{align*}	 
	...
	\subsection{Radon Measures in LCH Spaces}
	
	\begin{defn}
	Let $X$ be a LCH space, $\mu: \MB(X) \rightarrow \RG$ and $E \in \MB(X)$ a Borel measure. Then $\mu$ is said to be 
	\begin{enumerate}
	...
	\begin{defn}
	Let $X$ be a LCH space, $\mu: \MB(X) \rightarrow \RG$ and $E \in \MB(X)$. Then $\mu$ is said to be a \textbf{Radon measure} if for each $E \in \MB(X)$, 
	\begin{enumerate}
	...
	\begin{ex}
	Let $X$ be a LCH space, $\mu:\MB(X) \rightarrow \RG$ a Radon measure and $f \in C_c(X)$. Then for each $p \in [1, \infty]$, $f \in L^p(\mu)$.
	\end{ex}
...
\end{align*}	 
	...
	\begin{defn}
	Let $X$ be a LCH space and $I: C_c(X) \rightarrow \C$ a linear functional. Then $I$ is said to be \textbf{positive} if for each $f \in C_c(X, \R)$, $f \geq 0 $ implies that $I(f) \geq 0$.
	\end{defn}
	
	\begin{ex}
	Let $X$ be a LCH space, $I: C_c(X) \rightarrow \C$ a positive linear functional and $f,g \in C_c(X, \R)$. If $f \geq g$, then $I(f) \geq I (g)$.  
	\end{ex}	
...
\end{enumerate}	 
	...
	\begin{ex}
	Let $X$ be a LCH space, $\mu: \MB(X) \rightarrow \RG$ a Radon measure and $E \in \MA$. If $\mu(E) < \infty$, then for each $\ep >0$, there exist $U, V \in \MA$ such that $U$ and $V$ are open, $U \setminus E \subset V$ and $\mu(V) < \ep$. \\
	\textbf{Hint:} apply outer regularity twice
	\end{ex}
	
	\begin{proof}
	Suppose that $\mu(E) < \infty$. Let $\ep >0$. Outer regularity implies that there exists $U \in \MA$ such that $U$ is open, $E \subset U$ and $\mu(U) < \mu(E) + \ep$. Then 
	\begin{align*}
	\mu(U \setminus E) 
	&= \mu(U ) - \mu(U \cap E) \\
	&= \mu(U) - \mu(E) \\
	& < \ep
	\end{align*}
	Outer regularity implies that there exists $V \in \MA$ such that $V$ is open, $U \setminus E \subset V$ and $\mu(V) < \ep$.
\end{proof}		
