...
\begin{document}
	...
	\begin{ex} \lex{Measurabl Functions:0008}
	...
	\end{defn}
		...
		Let $X$ be a set, $\nu$ an outer measure on $X$ and $A \subset X$. Then $A$ is said to be $\nu$-\textbf{outer measurable} if for each $E \subset X$, 
	\begin{equation*}
	\nu(E) = \nu(E \cap A) + \nu(E \cap A^c)
	\end{equation*}
	\end{defn}
	...
	Let $X$ be a set, $\nu$ an outer measure on $X$ and $A \subset X$. Then $A$ is $\nu$-outer measurable iff for each $E \subset X$, $\nu(E) < \infty$ implies that 
	\begin{equation*}
	\nu(E) \geq \nu(E \cap A) + \nu(E \cap A^c)
	\end{equation*}
	\end{ex}	
	...
	\begin{proof}
	Suppose that $A$ is $\nu$-outer measurable. Let $E \subset X$, Suppose that $\nu(E) < \infty$. By definition $\nu(E) \geq \nu(E \cap A) + \nu(E \cap A^c)$. \\
	...
	\begin{ex} \lex{ex:outer_measures:00005.1} 
		Let $(X, \MA)$ be a measurable space and $\mu: \MA \rightarrow \RG$ a measure on $(X, \MA)$. Then $\mu^*|_{\MA} = \mu$.
	\end{ex}
	...
	\begin{ex}
		Let $(X, \MA)$ be a measurable space and $\mu: \MA \rightarrow \RG$ a measure on $(X, \MA)$. Then for each $A \subset X$, there exists $B \in \MA$ such that $A \subset B$ and $\mu^*(A) = \mu(B)$. 
	\end{ex}

	\begin{proof}
		Let $A \subset X$.
		\begin{itemize}
			\item  Suppose that $\mu^*(A) = \infty$. Set $B = X$. Then \tcb{ the previous exercise} implies that
			\begin{align*}
				\mu(B)
				& = \mu(X) \\
				& = \mu^*(X) \\
			...
			\begin{align*}
				...
				& = B
			\end{align*}
			 \tcb{The previous exercise} implies that
			\begin{align*}
				\mu^*(A)
				& \leq \mu^*(B) \\
				& = \mu(B)
	...
	\begin{defn} \ld{def:outer_measures:00005.2} 
		Let $X$ be a set and $\nu$ and outer measure on $X$. We define $\MA_{\nu} = \{A \subset X: A \text{ is }\nu \text{-measurable}\}$. 
	\end{defn}
	
	\begin{ex}  \lex{ex:outer_measures:00006} 
		Let $X$ be a set and $\nu$ an outer measure on $X$. Define $\MA_{\nu}$ is a $\sig$-algebra on $X$ and $\nu|_{\MA}$ is a complete measure on $(X, \MA)$.
	\end{ex}
	...
	\begin{thm} \lex{ex:outer_measures:00008} 
	...
	\begin{proof}
		Let $E \in \MA$. Set $V(E) = \{\nu(F): F \in \MA \text{ and $F$ $\mu^*$-covers $E$}\}$. Since $\mu^*(E \setminus E) = 0$, $\nu(E) \in V(E)$ and therefore
		\begin{align*}
			\nu_{\mu}(E)
			& = \inf V(E) \\
			& \leq \nu(E)
	...
	\begin{ex}  \lex{ex:outer_measures:00013} 
		Let $(X, \MA)$ be a measurable space, $\mu, \nu$ measures on $(X, \MA)$, $A \subset X$ and $E \in \MA$. If $E$ $\mu^*$-covers $A$ and $\nu(E) = 0$, then $\nu_{\mu}(A) = 0$. 
	\end{ex}
	...
	\begin{ex}  \lex{ex:outer_measures:00014} 
		Let $(X, \MA)$ be a measurable space and $\mu, \nu$ measures on $(X, \MA)$. Let $A \subset X$ and $E \in \MA$. If $E$ $\mu^*$-covers $A$, then for each $B \subset A$, $\nu_{\mu}(B) = \nu_{\mu}(B \cap E)$.
	\end{ex}
	...
	\begin{defn} \ld{def:subspace_measures:00001} 
		Let $(X, \MA)$ be a measurable space, $\mu$ a measure on $(X, \MA)$ and $E \in \MA$. We define the \tbf{restriction of $\mu$ to $E$}, denoted $\mu|_E: \MA \cap E \rightarrow \RG$, by 
		$$\mu|_E(A) = \mu(A)$$
	\end{defn}

	\begin{ex} \lex{ex:subspace_measures:00002} 
		Let $(X, \MA)$ be a measurable space, $\mu$ a measure on $(X, \MA)$ and $E \in \MA$. Then $\mu|_E$ is a measure on $(E, \MA \cap E)$. 
	\end{ex}
...
\section{Coproduct Measures}
	...
	\begin{proof}\
		\begin{enumerate}
			...
			From above, we have that for each $n \in \N$, $\lam_n \in \MM(X, \MA)$. For $n \in \N$, we define $g_n \in L^+(\N, \MP(\N))$ by 
	...
	\begin{ex} \lex{Integration of Complex Valued Functions 00010} 
...
\end{align*}		
	...
	\begin{proof}
		...
		\begin{align*}
			...
			& = \int_E 0 \dmu 
		\end{align*}
		Since $E \in \MA$ is arbitrary, \rex{Integration of Complex Valued Functions 00010}  implies that $\frac{d \nu}{d \mu} \geq 0$ $\mu$-a.e.
		\tcb{fix this}
	\end{proof}
	...
	\begin{defn}
		Let $(X, \MA)$ be a measurable space, $\mu \in \MM(X, \MA)$ and $A \in \MA$. Then $\mu$ is said to be \tbf{supported on $A$} if for each $E \in \MA$, $\mu(E) = \mu(A \cap E)$. \\
	...
	\begin{ex} \lex{43012}
		Let $(X, \MA)$, $(Y, \MB)$ be measurable spaces, $\mu, \nu \in \MM(X,\MA)$ and $f: X \rightarrow Y$. Suppose that $f$ is $(\MA, \MB)$-measurable. If $\nu \ll \mu$, then $f_*\nu \ll f_*\mu$ and 
	...
	\begin{ex} \lex{43013}
		Let $(X, \MA)$, $(Y, \MB)$ be measurable spaces, $\mu, \nu \in \MM(X, \MA)$ and $f: X \rightarrow Y$. Suppose that $f$ is an isomorphism. If $\nu \ll \mu$, then $f_*\nu \ll f_*\mu$ and 
		$$\frac{d f_*\nu}{d f_*\mu} \circ f = \frac{d\nu}{d \mu}  \hspace{.5cm} \text{ $\mu$-a.e.}$$ 
	\end{ex}
	...
	\begin{ex}
		Let $X$ be a topological space, $\mu: \MB(X) \rightarrow \RG$ a measure. If 
	\end{ex}
	...
	\begin{defn} \ld{00000} 
	Let $X$ be a topological space, $\mu: \MB(X) \rightarrow \RG$ a measure. Then $\mu$ is said to be \textbf{Radon} if for each $E \in \MB(X)$, 
	\begin{enumerate}
	...
	\begin{ex}
		Let $X$ be a topological space, $\mu$ a measure on $(X, \MB(X))$ and $E \in \MB(X)$. Suppose that $X$ is Hausdorff. If $E$ is closed and $\mu$ is Radon, then $\mu|_E$ is Radon. 
	\end{ex}
	
	\begin{proof}Suppose that $E$ is closed and $\mu$ is Radon. 
		\begin{enumerate}
			...
			$$V(B) = \{\mu(U): U \subset X \text{, $U$ is open in $X$ and $B \subset U$}\}$$ 
			and 
			$$V_E(B) = \{\mu|_E(U): U \subset E \text{, $U$ is open in $E$ and $B \subset U$}\}$$
			...
			\begin{itemize}
				...
				\begin{align*}
					...
					& = \sup V_E(B)
				\end{align*}
				\item Now, suppose that $\mu|E(B) < \infty$. Clearly $\mu|_E(B) \leq \inf V_E(B)$. Then 
				\begin{align*}
					\mu(B)
					& = \mu|_E(B) \\
					& < \infty
			...
			\item Let $U \subset E$. Suppose that $U$ is open in $E$. Then there exists $U_0 \subset X$ such that $U_0$ is open in $X$ and $U = U_0 \cap E$. Since $E \in \MB(X)$, $U \in \MB(X)$. Set 
			$$V_E(U) = \{\mu|_E(K): K \subset U \text{ and $K$ is compact}\}$$
			\begin{itemize}
				\item First, suppose that $\mu|_E(U) = \infty$. Let $M > 0$. Since $X$ is $\sig$-finite \rex{ex:measures:00009} implies that there exists $(F_n)_{n \in \N} \subset \MB(X)$ such that 
				\begin{enumerate}
					\item $X = \bigcup\limits_{n \in \N} F_n$
					\item for each $n \in \N$, $\mu(F_n) < \infty$
					\item for each $n \in \N$, $F_n \subset F_{n+1}$
				\end{enumerate}
				Since for each $n \in \N$, $U \cap F_n \subset U \cap F_{n+1}$ and
				\begin{align*}
					\bigcup_{n \in \N} (U \cap F_n)
					& = U \cap \bigg[ \bigcup F_n \bigg] \\
					& = U \cap X \\
					& = U 
				\end{align*}
				\rex{ex:measures:00004} implies that 
				\begin{align*}
					\sup_{n \in \N} \mu(U \cap F_n)
					& = \mu(U) \\
					& = \mu|_E(U) \\
					& = \infty 
				\end{align*}
				Hence there exists $N \in \N$ such that $\mu(U \cap F_N) > M + 1$. Since $\mu(F_N) < \infty$, we have that 
				\begin{align*}
					\mu(U \cap F_N)
					& \leq \mu(F_N) \\
					& < \infty 
				\end{align*}
				Since $U \cap F_n \in \MB(X)$, outer regularity of $\mu$ implies that there exists $V_0 \subset X$ such that $V_0$ is open in $X$, $U \cap F_N \subset V_0$ and $\mu(V_0) \leq \mu(U \cap F_N) + 1$. Since $\mu(V_0) < \infty$, we have that 
				\begin{align*}
					\mu(U_0 \cap V_0) 
					& \leq \mu(V_0) \\
					& < \infty 
				\end{align*}
				Since $U_0 \cap V_0$ is open in $X$, outer regularity of $\mu$ implies that there exists $K_0 \subset X$ such that $K_0$ is compact in $X$, $K_0 \subset U_0 \cap V_0$ and $\mu(K_0) > \mu(U_0 \cap V_0) - 1$. Set $K = K_0 \cap E$. Since $X$ is Hausdorff, $K_0$ is closed in $X$. Since $E$ is closed in $X$, $K$ is closed in $X$. Since $K_0$ is compact in $X$ and $K \subset K_0$, $K$ is compact in $X$. Therefore $K$ is compact in $E$. Since $K_0 \subset U_0 \cap V_0$, we have that
				\begin{align*}
					K 
					& \subset U \cap V_0 \\
					& \subset U
				...
				and 
				\begin{align*}
					\mu[(U_0 \cap V_0) \cap K_0^c] 
					& = \mu(U_0 \cap V_0) - \mu(K_0) \\
					& < 1
				\end{align*}
				Since $U \cap F_N \subset V_0$, we have that $U \cap F_N \subset U \cap V_0$. Hence
				\begin{align*}
					\mu|_E(K)
					& = \mu(K) \\
					& = \mu(K_0 \cap E) \\
					& = \mu(U_0 \cap V_0 \cap K_0 \cap E) \\
					& = \mu(U_0 \cap V_0 \cap E) - \mu(U_0 \cap V_0 \cap E \cap K_0^c) \\
					& = \mu(U \cap V_0) - [\mu(U_0 \cap V_0) - \mu(K_0)] \\
					& \geq \mu(U \cap F_N) - [\mu(U_0 \cap V_0) - \mu(K_0)] \\
					& > (M+1) - 1 \\
					& = M
				\end{align*}
				Since $M > 0$ is arbitrary, we have that for each $M > 0$, there exists $K \subset U$ such that $K$ is compact and $\mu|_E(K) > M$. Thus 
				\begin{align*}
					\mu|_E(U)
					& = \infty \\
					& = \sup V_E(U)
				\end{align*} 
				\item Now, suppose that $\mu(U) < \infty$. Clearly 
				$$\sup V_E(U) \leq \mu|_E(U)$$ 
				Let $\ep > 0$. Outer regularity of $\mu$ implies that there exists $V_0 \subset X$ such that $V_0$ is open in $X$, $U \subset V_0$ and $\mu(V_0) < \mu(U) + \ep$. Since $U_0 \cap V_0$ is open in $X$, inner regularity of $\mu$ implies that there exists $K_0 \subset X$ such that $K_0$ is compact in $X$, $K_0 \subset U_0 \cap V_0$ and $\mu(K_0) > \mu(U_0 \cap V_0) - \ep$. Set $K = K_0 \cap E$. Since $X$ is Hausdorff and $K$ is compact in $X$, $K$ is closed in $X$. Since $E$ is closed in $X$, $K$ is closed in $X$. Therefore $K$ is compact in $X$. Hence $K$ is compact in $E$. Since $K_0 \subset U_0 \cap V_0$, we have that 
				\begin{align*}
					\mu[(U_0 \cap V_0) \cap K_0^c] 
					& = \mu(U_0 \cap V_0) - \mu(K_0) \\
					& < \ep
				...
				\begin{align*}
					...
					& = \mu(U) \\
					& = \mu(U \cap V_0) \\
					& = \mu(U_0 \cap V_0 \cap E) \\
					& = \mu[(U_0 \cap V_0 \cap E) \cap K_0] + \mu[(U_0 \cap V_0 \cap E) \cap K_0^c] \\
					& \leq \mu(K_0 \cap E) + \mu(U_0 \cap V_0 \cap K_0^c) \\
					& < \mu(K)  + \ep \\
					& = \mu|_E(K) + \ep 
				\end{align*}
				Thus 
				$$\sup V_E(U) \geq \mu|_E(U)$$
				Hence $	\mu|_E(U) = \sup V_E(U)$.
			\end{itemize}
			Thus $\mu|_E$ is inner regular on $U$.
		\end{enumerate}
		Therefore $\mu|_E$ is Radon.
	\end{proof}

		\begin{defn}
		Let $X$ be a topological space, $\mu$ a measure on $(X, \MB(X))$. Then 
		\begin{itemize}
			\item $\mu$ is said to be \tbf{$F_{\sig}$-finite} if there exists $(E_n)_{n \in \N} \subset \MB(X)$ such that
			\begin{enumerate}
				\item for each $n \in \N$, $E_n$ is closed and $\mu(E_n) < \infty$
				\item $X = \bigcup\limits_{n \in \N} E_n$
				\item 
			\end{enumerate}
			\item $\mu$ is said to be \tbf{$G_{\del}$-finite}
			if there exists $(U_n)_{n \in \N} \subset \MB(X)$ such that
			\begin{enumerate}
				\item for each $n \in \N$, $U_n$ is open and $\mu(U_n) < \infty$
	...
	\begin{ex}
		Let $X$ be a topological space, $\nu, \mu$ measures on $(X, \MB(X))$. If $\nu$ and $\mu$ are $F_{\sig}$-finite, then there exists $(E_n)_{n \in \N} \subset \MB(X)$ such that 
		\begin{enumerate}
			\item $X = \bigcup\limits_{n \in \N} E_n$
			\item for each $n \in \N$,
			\begin{itemize}
	...
	\begin{proof}
		Suppose that $\nu$ and $\mu$ are $F_{\sig}$-finite. By definition, there exist $(F^{\nu}_j)_{j \in \N}, (F^{\mu}_k)_{k \in \N} \subset \MB(X)$ such that $X = \bigcup\limits_{j \in \N} F^{\nu}_j$, $X = \bigcup\limits_{k \in \N} F^{\mu}_k$ and for each $j,k \in \N$, $F^{\nu}_j, F^{\mu}_k$ are closed and $\nu(F^{\nu}_j), \mu(F^{\nu}_k) < \infty$. Define $(F_{j,k})_{j,k \in \N} \subset \MB(X)$ and $(E_n)_{n \in \N} \subset \MB(X)$ by $F_{j,k} = F^{\nu}_j \cap F^{\mu}_k$ and $E_n = \bigcup\limits_{j,k \leq n} F_{j, k}$.
		\begin{enumerate}
			\item We see that 
			\begin{align*}
				X
			...
			\item Let $n \in \N$
			\begin{itemize}
				\item Let $j,k \in \N$. Suppose that $j,k \leq n$. Since $F^{\nu}_j$ and $F^{\mu}_k$ are closed, $F_{j,k} = F^{\nu}_j  \cap F^{\mu}_k$ is closed. Since $j,k \in \N$ with $j,k \leq n$ are arbitrary, we have that $E_n = \bigcup\limits_{j,k \leq n} F_{j, k}$ is closed. 
				\item We have that  
				\begin{align*}
					E_n
	...
	\begin{defn}
		Let $X$ be a topological space and $\mu$ a measure on $(X, \MB(X))$. Suppose that $\mu$ is Radon. We define 
		\begin{itemize}
			\item the \tbf{$\mu$-null open sets}, denoted $\MN_{\mu} \subset \MB(X)$, by $$\MN_{\mu} = \{U \subset X: U \text{ is open and } \mu(U) = 0\}$$ 
			\item the \tbf{support of $\mu$}, denoted $\supp \mu$, by 
			$$\supp \mu = \bigg[ \bigcup_{U \in \MN_{\mu}} U \bigg]^c$$ 
		\end{itemize}
	\end{defn}

	\begin{ex} \lex{00000} 
		Let $X$ be a topological space and $\mu$ a measure on $(X, \MB(X))$. Suppose that $\mu$ is Radon. Define $N_{\mu} = (\supp \mu)^c$. Then 
		\begin{enumerate}
			\item $N_{\mu}$ is open
	...
	\begin{ex}
		Let $X$ be a topological space and $\mu$ a measure on $(X, \MB(X))$. Suppose that $\mu$ is Radon. Let $x \in \supp \mu$. Then for each $U \in \MN_x$, $\mu(U) > 0$.
	\end{ex}

	\begin{proof}
		Let $U \in \MN_x$. For the sake of contradiction, suppose that $\mu(U) = 0$. Then $\mu(\Int U) = 0$ and thus $\Int U \in \MN_{\mu}$. Therefore
		\begin{align*}
			x
			& \in \Int U \\
	...
	\begin{ex}
		Let $X$ be a topological space and $\mu, \nu \in \MM^+(X)$, Suppose that $\nu$ is Radon. Then for each $A \in \MB(X)$,  
		$$\nu_{\mu}(A) = \inf \{\nu(U): \text{ $U \subset X$ is open and $U$ $\mu^*$-covers $A$} \}$$
	\end{ex}
	
	\begin{proof}
		For each $A \subset X$, set 
		$$V(A) = \{\nu(U): \text{ $E \in \MB(X)$ and $U$ $\mu^*$-covers $A$} \}$$ 
		and  
		$$V'(A) = \{\nu(U): \text{ $U \subset X$ is open and $U$ $\mu^*$-covers $A$} \}$$
		Since $V'(A) \subset V(A)$, we have that 
		\begin{align*}
	...
	\begin{proof}
		...
		$$\nu_{\mu}(A) \geq \nu_{\mu}(A \cap U) + \nu_{\mu}(A \cap U^c)$$
		Since $A \subset X$ with $\nu_{\mu}(A) < \infty$ is arbitrary, $U \in \MA_{\nu_{\mu}}$. Since $U \subset X$ with $U$ is open is arbitrary, $\MB(X) \subset \MA_{\nu_{\mu}}$. 
	\end{proof}

	\begin{note}
		Unless otherwise specified, we will write $\nu_{\mu}$ in place of $\nu_{\mu}|_{\MB(X)}$ and think of $\nu_{\mu}$ as a measure on $(X, \MB(X))$.
	\end{note}

	\begin{defn}
		Let $X$ be a topological space and $\mu, \nu$ measures on $(X, \MB(X))$. Suppose that $\nu$ is a Radon. We define $\nu_{\mu}^{\perp} \in \MM^+(X)$ by $\nu_{\mu}^{\perp} = \nu - \nu_{\mu}$.
	\end{defn}

	\begin{ex}
		Let $X$ be a topological space and $\mu, \nu$ measures on $(X, \MB(X))$. Suppose that $\mu,\nu$ are-finite and $\nu$ is Radon. Then $\nu_{\mu}^{\perp} \perp \nu_{\mu}$. \\
	...
	\begin{ex}
		Let $X$ be a Hausdorff topological space and $\mu, \nu$ measures on $(X, \MB(X))$. Suppose that $\mu,\nu$ are $F_{\sig}$-finite and $\nu$ is Radon. Then 
		\begin{enumerate}
			\item $\nu_{\mu} \ll \mu$
			\item $\nu_{\mu}^{\perp} \perp \mu$
	...
	\begin{proof}\
		\begin{enumerate}
			...
			\begin{align*}
				...
				& = 0
			\end{align*}
			Hence $\nu_{\mu}(E)$. Since $E \in \MB(X)$ with $\mu(E) = 0$ is arbitrary, $\nu_{\mu} \ll \mu$.
			\item Since $\mu,\nu$ are $F_{\sig}$-finite, a previous exercise implies that there exists $(E_n)_{n \in \N} \subset \MB(X)$ such that 
			\begin{enumerate}
				\item $X = \bigcup\limits_{n \in \N} E_n$
				\item for each $n \in \N$,
				\begin{itemize}
				...
				\end{itemize}
			\end{enumerate} 
			Let $n \in \N$. Since $\nu(E_n), \mu(E_n) < \infty$, $\nu|_{E_n}$ and $\mu|_{E_n}$ are finite measures. Since $E_n$ is closed, a previous exercise implies that $\nu|_{E_n}$ is Radon.  \rex{ex:subspace_measures:00007} implies that 
			\begin{align*}
				\nu_{\mu}^{\perp}|_{E_n} 
				& = (\nu - \nu_{\mu})|_{E_n} \\
				& = \nu|_{E_n} - \nu_{\mu}|_{E_n} \\
...
\end{enumerate}	 
	...
	\begin{defn}
		...
		\begin{itemize}
			...
			$$\MC(A) = \{ \MV \in \bar{\MB}_X: \MV \text{ is a centered covering of } A\}$$
	...
	\begin{defn}
		Let $(X, d)$ be a metric space and $\mu$ a measure on $(X, \MB(X))$. Then $\mu$ is said to be \tbf{Vitali} if for each $A \subset X$ and $\MV \in \MC(A)$, $\MV$ is fine on $A$ implies that there exists $\MF \subset \MV$ such that 
		\begin{enumerate}
	...
	\begin{ex}
		Let $(X, d)$ be a seprable ultrametric space and $\mu$ a measure on $(X, \MB(X))$. Suppose that there exists $\MP: \N \rightarrow \Part(X)$ such that $\MP^d = \bar{\MP}$. Then $\mu$ is Vitali. \\
	...
	\begin{ex}
		Let $(X, d)$ be an ultra metric space and  $\mu$ a measure on $(X, \MB(X))$ and $\MP:\N \rightarrow \Part(X)$. Suppose that $X$ is separable and  
		\begin{enumerate}
			\item for each $n \in \N$ and $S \in \MP_n$, there exists $x \in X$ and $r > 0$ such that $S = \bar{B}(x, r)$
			\item $\MP$ is decreasing 
			\item $\limsup\limits_{n \rightarrow \infty} \bigg[ \sup\limits_{S \in \MP_n} \diam(S) \bigg]  = 0$
		\end{enumerate}
		Set $\MV(\MP) \defeq \bigcup\limits_{n \in \N}\MP_{n}$. Then $\MV(\MP)$ is $\mu$-Vitali
	\end{ex}
	
	\begin{proof}\
		\begin{enumerate}
			\item Let $x \in X$. Since $\MP_1 \in \Part(X)$, there exists $S_x \in \MP_1$ such that $x \in S$. Then 
			\begin{align*}
				x 
				& \in S_x \\
				& \subset \bigcup_{S \in \MV(\MP)} S
			\end{align*}
			Since $x \in X$ is arbitrary, we have that $X \subset \bigcup\limits_{S \in \MV(\MP)} S$. So $\MV(\MP)$ is a covering of $X$.
			\item Let $x \in X$ and $\ep >0$. Since $\limsup\limits_{n \rightarrow \infty} \bigg[ \sup\limits_{S \in \MP_n} \diam(S) \bigg]  = 0$, there exists $N \in \N$ such that for each $n \geq N$ and $S \in \MP_n$, $\diam(S)< \ep$. Since $\MP_N \in \Part(X)$, there exists $S_x \in \MP_N$, such that $x \in S_x$. Then $S_x \in \MV(\MP)$ and 
			\begin{align*}
				\inf \{\diam(S): S \in \MV(\MP) \text{ and } x \in S\}
				& \leq \diam(S_x) \\
				& < \ep 
			\end{align*} 
			Since $\ep > 0$ is arbitrary, $\inf \{\diam(S): S \in \MV(\MP) \text{ and } x \in S\} = 0$. Hence $\MV(\MP)$ is fine at $x$.  
			\item \tcb{Recall $\pi^{\MP}_n: X \rightarrow X/ \sim_{\MP_n}$ as in the analysis notes -ultrametric spaces. Then for each $n \in \N$, $\MP_n = \{\pi^{\MP}_n(z): x \in X\}$}\\
			Let $A \subset X$ and $\MV' \subset \MV(\MP)$. Suppose that $\MV'$ is a covering of $A$ and for each $x \in A$, $\MV'$ is fine at $x$. \\
			Let $z \in A$. Since $\MV'$ is a covering of $A$, there exists $S \in \MV'$ such that $z \in S$. Since 
			\begin{align*}
				S
				& \in  \MV'\\
				& \subset \MV(\MP) \\
				& = \bigcup_{n \in \N} \MP_n \\
				& = \bigcup_{n \in \N} \{\pi^{\MP}_n(x): x \in X\} \\
				& = \{\pi^{\MP}_n(x): x \in X \text{ and } n \in \N\} 
			\end{align*} 
			there exists $n \in \N$ and $x \in X$ such that $S = \pi^{\MP}_n(x)$. Since $z \in \pi^{\MP}_n(x)$ and $\MP_n \in \Part(X)$, we have that 
			\begin{align*}
				\pi^{\MP}_n(z) 
				& = \pi^{\MP}_n(x) \\
				& = S \\
				& \in \MV'
			\end{align*}
			Since $z \in A$ is arbitrary, we have that for each $z \in A$, $\{n \in \N: \pi^{\MP}_n(z) \in \MV'\} \neq \varnothing$. \\
			Since $X$ is separable, $A$ is separable. Thus there exists $(z_n)_{n \in \N} \subset A$ such that $(z_n)_{n \in \N}$ is dense in $A$. For each $k \in \N$, set $n_k = \min \{n \in \N: \pi^{\MP}_n(z_k) \in \MV' \}$. Define $\MF \subset \MV'$ by $\MF = \{\pi^{\MP}_{n_k}(z_k): k \in \N\}$. 
			\begin{enumerate}
				\item By construction $\MF$ is countable.
				\item Let $k_1, k_2 \in \N$. Suppose that $\pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_2}}(z_{k_2}) \neq \varnothing$. Then there exists $x \in X$ such that $x \in \pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_2}}(z_{k_2})$. 
				\begin{itemize}
					\item For the sake of contradiction, suppose that $n_{k_1} < n_{k_2}$. Since $\MP$ is decreasing, \tcb{an exercise in the section on ultrametric spaces in the analysis notes } implies that $\pi^{\MP}_{n_{k_2}}(z_{k_2}) \subset \pi^{\MP}_{n_{k_1}}(z_{k_2})$. Then
					\begin{align*}
						x
						& \in \pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_2}}(z_{k_2}) \\
						& \subset \pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_1}}(z_{k_2}) 
					\end{align*}
					Since $\MP_{n_{k_1}} \in \Part(X)$ and $\pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_1}}(z_{k_2}) \neq \varnothing$, we have that 
					\begin{align*}
						\pi^{\MP}_{n_{k_1}}(z_{k_2})
						& = \pi^{\MP}_{n_{k_1}}(z_{k_1}) \\
						& \in \MV'
					\end{align*}
					Therefore
					\begin{align*}
						\min \{n \in \N: \pi^{\MP}_n(z_{k_2}) \in \MV'\}
						& \leq n_{k_1} \\
						& < n_{k_2} \\
						& = \min \{n \in \N: \pi^{\MP}_n(z_{k_2}) \in \MV'\}
					\end{align*}
					...
					\item Similarly, $n_{k_1} \leq n_{k_2}$.
				\end{itemize}
				Thus $n_{k_1} = n_{k_2}$. Since $k_1, k_2 \in \N$ are arbitrary, we have that for each $k_1, k_2 \in \N$, $\pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_2}}(z_{k_2}) \neq \varnothing$ implies that $\pi^{\MP}_{n_{k_1}}(z_{k_1}) = \pi^{\MP}_{n_{k_2}}(z_{k_2})$. Equivalently, for each $k_1, k_2 \in \N$, $\pi^{\MP}_{n_{k_1}}(z_{k_1}) \neq \pi^{\MP}_{n_{k_2}}(z_{k_2})$ implies that $\pi^{\MP}_{n_{k_1}}(z_{k_1}) \cap \pi^{\MP}_{n_{k_2}}(z_{k_2}) = \varnothing$. Hence $\MF$ is disjoint.
				\item Let $z \in A$. Since $\MV'$ is a covering of $A$, there exists $S \in \MV'$ such that $z \in S$. As in part (b), there exists $n \in \N$ such that $S = \pi^{\MP}_n(z)$. By assumption, there exists $x \in X$ and $r > 0$ such that 
				\begin{align*}
					\pi^{\MP}_n(z) 
					& = S \\
					& = \bar{B}(x, r)
				\end{align*}
				Then $\Int \pi^{\MP}_n(z)  \neq \varnothing$ and since $(z_k)_{k \in \N}$ is dense in $A$, there exists $k \in \N$ such that $z_k \in \Int \pi^{\MP}_n(z)$. Since $\MP_n \in \Part(X)$, $\pi^{\MP}_n(z_k) = \pi^{\MP}_n(z)$. Since $\MP$ is decreasing, we have that 
				\begin{align*}
					z
					& \in \pi^{\MP}_n(z_k) \\
					& \subset \pi^{\MP}_{n_k}(z_k) \\
					& \in \MF 
				\end{align*}
				Since $z \in A$ is arbitrary, we have that $A \subset \bigcup\limits_{S \in \MF}S$. Therefore 
				\begin{align*}
					\mu \bigg[ A \setminus \bigg(\bigcup_{S \in \MF}S \bigg) \bigg] 
					& = \mu \bigg[ A \cap \bigg(\bigcup_{S \in \MF}S \bigg)^c \bigg] \\ 
					& = \mu(\varnothing) \\
				...
				Hence $\MF$ $\mu^*$-covers $A$. 
			\end{enumerate}
			So $\MV(\MP)$ is $\mu$-Vitali.
		\end{enumerate}
	\end{proof}

	\begin{ex}
		Let $(X, d)$ be a metric space, $\mu$, $\al$ and $\be$ measures on $(X, \MB(X))$ and $\MV$ a covering of $X$. Suppose that $\al, \be, \mu$ are Radon, $\be$ is finite and $\MV$ is $\mu$-Vitali. Let $c > 0$ and $A \subset \bigg\{x \in X: \liminf\limits_{\MV \rightarrow x} \al / \be < c \bigg \}$, then $\al_{\mu}^*(A) \leq c \be_{\mu}^*(A)$.
	\end{ex}

	\subsection{Differentiation}

	\begin{ex}
		Let $X$ be a metric space and $\mu$ a Radon measure on $(X, \MB(X))$. Suppose that $\mu$ is finite. Let $r > 0$. Define $f: X \rightarrow \Rg$ by $f(x) = \mu(\bar{B}(x, r))$. Then $f$ is upper semi-continuous.
	\end{ex}

	\begin{proof}
		Let $(x_n)_{n \in \N} \subset X$, $x \in X$ and $\ep > 0$. Let $k \in \N$. Suppose that $x_n \rightarrow x$. \tcb{An exercise in the introduction section on metric spaces in the analysis notes} implies that there exists $N_0 \in \N$ such that for each $n \in \N$, $n \geq N_0$ implies that $\bar{B}(x_n, r) \subset \bar{B}(x, r + k^{-1})$. Let $n \in \N$. Suppose that $n \geq N_0$. Then $\mu(\bar{B}(x_n, r)) \leq  \bar{B}(x, r + k^{-1})$. Since $n \in \N$ with $n \geq N_0$ is arbitrary, we have that $\sup\limits_{n \geq N_0} \mu(\bar{B}(x_n, r)) \leq \mu(\bar{B}(x, r + k^{-1}))$. Therefore
		\begin{align*}
		...
		Since $\mu$ is finite, $(\bar{B}(x, r + k^{-1}))_{k \in \N}$ is decreasing and $ \inf\limits_{k \in \N} \bar{B}(x, r + k^{-1}) = \bar{B}(x, r)$, we have that 
		\begin{align*}
			\limsup_{n \rightarrow \infty} f(x_n)
