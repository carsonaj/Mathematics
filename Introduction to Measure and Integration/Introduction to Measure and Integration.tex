...
\begin{document}
	...
	\begin{defn} \ld{00000} 
		Let $X$ be a topological space and $\MB \subset \MP(X)$. Then $\MB$ is said to be a \tbf{$\al$-system} if for each $(A_n)_{n \in \N} \subset \MB$,
		\begin{enumerate}
	...
	\tcr{come up with better names than OIU and OIDU, etc}
	
	\begin{defn}
		Let $X$ be a topological space and $\MB \subset \MP(X)$. Then $\MB$ is said to be a \tbf{OIU class} if 
		\begin{enumerate}
	...
	\begin{defn}
		Let $X$ be a topological space and $\MB \subset \MP(X)$. Then $\MB$ is said to be a \tbf{OIU class} if
		\begin{enumerate}
			\item for each $C \subset X$ if $C$ is closed, then $C \in \MB$ 
			\item for each $(A_n)_{n \in \N} \subset \MB$, $\bigcap\limits_{n \in \N} A_n \in \MB$
			\item for each $(A_n)_{n \in \N} \subset \MB$, $\bigcup\limits_{n \in \N} A_n \in \MB$
		\end{enumerate}
	\end{defn}
	...
	\begin{defn}
		Let $X$ be a topological space and $\MB \subset \MP(X)$. Then $\MB$ is said to be a \tbf{OIDU class} if
		\begin{enumerate}
			\item for each $U \subset X$ if $U$ is open, then $U \in \MB$ 
			\item for each $(A_n)_{n \in \N} \subset \MB$, $\bigcap\limits_{n \in \N} A_n \in \MB$
			\item for each $(A_n)_{n \in \N} \subset \MB$, if $(A_n)_{n \in \N}$ is disjoint, then $\bigcup\limits_{n \in \N} A_n \in \MB$
		\end{enumerate}
	\end{defn}

	\begin{defn}
		Let $X$ be a topological space and $\MB \subset \MP(X)$. Then $\MB$ is said to be a \tbf{CIDU class} if
		\begin{enumerate}
			\item for each $C \subset X$ if $C$ is closed, then $C \in \MB$ 
			\item for each $(A_n)_{n \in \N} \subset \MB$, $\bigcap\limits_{n \in \N} A_n \in \MB$
			\item for each $(A_n)_{n \in \N} \subset \MB$, if $(A_n)_{n \in \N}$ is disjoint, then $\bigcup\limits_{n \in \N} A_n \in \MB$
	...
	\begin{ex}
		Let $(X, d)$ be a metric space. Set $\ME_{\text{OIDU}} \defeq \{\MB \subset \MP(X): \MB \text{ is a OIDU class}\}$. $\MB \subset \MP(X)$. Define $\MB_0 \defeq \bigcap\limits_{\MB \in \ME_{\text{OIDU}}} \MB$.  
	\end{ex}
