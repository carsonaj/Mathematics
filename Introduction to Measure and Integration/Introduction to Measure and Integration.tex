...
\begin{document}
	...
	\begin{defn}  \ld{def:outer_measures:00004} 
		Let $X$ be a set and $\ME \subset \MP(X)$ and $\rho: \ME \rightarrow [0, \infty]$. Suppose that $\varnothing, X \in \ME$ and $\rho(\varnothing) = 0$. We define the \tbf{outer measure on $X$ induced by $\rho$}, denoted $\rho^*:\MP(X) \rightarrow [0, \infty]$, by 
	...
	\begin{ex}\textbf{Construction of Outer Measures:}  \lex{ex:outer_measures:00005}  \\
		Let $X$ be a set and $\ME \subset \MP(X)$ and $\rho: \ME \rightarrow [0, \infty]$. Suppose that $\varnothing, X \in \ME$ and $\rho(\varnothing) = 0$. Then $\rho^*$ is an outer measure on $X$.
	\end{ex}
	...
	\begin{note}
		In particular, for each $A \in \ME$, $\rho^*(A) = \rho(A)$.
	\end{note}

	\begin{defn} \ld{def:outer_measures:00005} 
	...
	\begin{proof}
		...
		$$V'(A) = \{\text{$\nu(E): E \in \MA$, $E \subset A$ and $E$ $\mu^*$-covers $A$} \}$$ 
		Suppose that $\nu_{\mu}(A) = \infty$. Since $V'(A) \subset V(A)$, we have that
		\begin{align*}
			\infty
			& = \nu_{\mu}(A) \\
			& = \inf V(A) \\
		...
		\begin{align*}
			...
			& < \nu_{\mu}(A) + \ep 
		\end{align*}
		Since $\ep > 0$ is arbitrary, $\inf V'(A) \leq \nu_{\mu}(A)$. Since $V'(A) \subset V(A)$, we have that
		\begin{align*}
			\nu_{\mu}(A)
			& = \inf V(A) \\
			& \leq \inf V'(A)
...
\end{align*}		
	...
	\begin{proof}
		...
		$$\nu_{\mu}(A) \geq \nu_{\mu}(A \cap U) + \nu_{\mu}(A \cap U^c)$$
		Since $A \subset X$ with $\nu_{\mu}(A) < \infty$ is arbitrary, $U$ is $\nu_{\mu}$-measurable. Since $U \subset X$ with $U$ is open is arbitrary, $\MB(X) \subset \MA_{\nu_{\mu}}$. 
	\end{proof}
	...
	\begin{ex}
		Let $X$ be a topological space, $\mu$ a measure on $(X, \MB(X))$ and $E \in \MB(X)$. If $\mu$ is Radon, then $\mu|_E$ is Radon. 
	\end{ex}

	\begin{proof}\
		\begin{enumerate}
			\item Let $U \subset E$. Suppose that $U$ is open in $E$. Then there exists $U_0 \subset X$ such that $U_0$ is open in $X$ and $U = U_0 \cap E$. Since $E \in \MB(X)$, $U \in \MB(X)$. 
			\begin{itemize}
				\item First, suppose that $\mu(U) = \infty$.  
				\item Now, suppose that $\mu(U) < \infty$. Let $\ep > 0$. Outer regularity of $\mu$ implies that there exists $V_0 \subset X$ such that $V_0$ is open in $X$, $U \subset V_0$ and $\mu(V_0) < \mu(U) + \ep$. Since $U_0 \cap V_0$ is open in $X$, inner regularity of $\mu$ implies that there exists $K_0 \subset X$ such that $K_0$ is compact in $X$, $K_0 \subset U_0 \cap V_0$ and $\mu(K_0) > \mu(U_0 \cap V_0) - \ep$. Set $K = K_0 \cap E$. Then \tcb{K is compact in E?}. Since $K_0 \subset U_0 \cap V_0$, we have that 
				\begin{align*}
					\mu[(U_0 \cap V_0) \cap K_0] 
			...
			\begin{itemize}
				\item First, suppose that 
				\item Now, suppose that $\mu(B) < \infty$. Let $\ep > 0$. Since $\mu$ is Radon, there exists $U \subset X$ such that $U$ is open in $X$, $B \subset U$ and $\mu(U) < \mu(B) + \ep$. Then $E \cap U$ is open in $E$, $B \subset U \cap E$ and 
				\begin{align*}
					\mu|_E(B)
					& = \mu(B) \\
					& \leq \mu(U) \\
			...
			\item Let $K \subset E$. Suppose that $K$ is compact in $E$. Since the inclusion $\iota:E \rightarrow X$ is continuous, $K$ is compact in $X$. Since $\mu$ is Radon, we have that 
			\begin{align*}
				\mu|_E(K)
				& = \mu(K) \\
				& < \infty
	...
	\begin{proof}\
		\begin{enumerate}
			\item Suppose that $\mu, \nu $ are finite. For the sake of contradiction, suppose that $\lam \not \perp \mu$. Then \tcb{Lemma 3.7 in Folland} implies that there exists $\ep >0$ and $E \in \MB(X)$ such that $\mu(E) > 0$ and $E$ is $(\lam - \ep \mu)$-positive. \\ 
			Suppose that $\nu_{\mu}(E) < \infty$. Set $\del = \ep \mu(E)/2$. \rex{ex:outer_measures:00012.1} implies that there exists $F \in \MB(X)$ such that $F \subset E$, $F$ $\mu^*$-covers $E$ and $\nu(F) < \nu_{\mu}(E) + \del$. Since $\mu^*|_{\MB(X)} = \mu$, we have that 
			\begin{align*}
				\mu(E)
			...
			\begin{align*}
				...
				& = \ep \mu(E)
			\end{align*} 
			which is a contradiction. Hence $\lam \perp \mu$. 
			\tcb{FINISH!!!, do restriction of measure/outer measure stuff and do the $\sig$-finite case}
			\item 
		\end{enumerate}
	\end{proof}
...
\end{enumerate}	 
	...
	\newpage
	\section{Differentiation of Measure on Metric Spaces}
	...
	\begin{note}
		Let $X$ be a set. In what follows, we equip $X \times \MP(X)$  with the standard projection maps $\pi_1: X \times \MP(X) \rightarrow X$ and $\pi_2: X \times \MP(X) \rightarrow \MP(X)$. 
	\end{note}
	
	\begin{defn}
		Let $(X,d)$ be a metric space. 
		\begin{itemize}
			\item Let $\MC \subset X \times \MP(X)$. Then $\MC$ is said to be a \tbf{covering relation} on $X$ if for each $A \in X \times \MP(X)$, 
			$$\pi_1(A) \in \pi_2(A)$$ 
			i.e. if for each $(x, S) \in \MC$, $x \in S$.
			\item Let $\MC$ be a covering relation on $X$ and $Z \subset X$. We define the restriction of $\MC$ to $Z$, denoted $\MC|_Z$, by 
			$$\MC|_Z = \pi_1|_{\MC}^{-1}(Z)$$
			i.e. $\MC|_Z = \{(x, S) \in \MC: x \in Z\}$.
			\item Let $\MC$ be a covering relation on $X$ and $x \in \pi_1(\MC)$. Then $\MC$ is said to be \tbf{fine} at $x$ if 
			$$\inf\limits_{S \in \pi_2(\MC|_x)} \diam(S) = 0$$
			i.e. if $\inf \{\diam(S): (x,S) \in \MC\} = 0$.
		\end{itemize} 
	\end{defn}
	
	\begin{defn}
		Let $(X, d)$ be a metric space, $\mu \in \MM(X)$ and $\MV$ be a covering relation on $X$. Then $\MV$ is said to be \tbf{$\mu$-Vitali} if 
		\begin{enumerate}
			\item $\pi_2(\MV) \subset \MB(X)$
			\item for each $x \in X$, $\MV$ is fine at $x$
			\item for each $\MC \subset \MV$ and $Z \subset \pi_1(\MC)$, if for each $x \in Z$, $\MC$ is fine at $x$, then there exists $\MF \subset \pi_2(\MC|_Z)$ such that 
			\begin{enumerate}
	...
	\begin{ex}
		Let $(X, d)$ be a separable metric space and $\MP:\N \rightarrow \Part(X)$. Suppose that $X$ is separable and  
		\begin{enumerate}
			\item for each $n \in \N$, $\MP_n \subset \MB(X)$ and $\MP_n$ is countable
			\item $\MP$ is decreasing \tcb{as in analysis notes - ultrametric spaces}
			\item $\limsup\limits_{n \rightarrow \infty} \bigg[ \sup\limits_{S \in \MP_n} \diam(S) \bigg]  = 0$
		\end{enumerate}
		Set $\MV(\MP) = \bigg \{(x, S): S \in \bigcup\limits_{n \in \N}\MP_{n} \text{ and $x \in S$} \bigg\}$. Then $\MV(P)$ is $\mu$-Vitali
	\end{ex}
	...
	\begin{proof}\
		\begin{enumerate}
			...
			\begin{align*}
				\pi_2(\MV(\MP))
				& \subset \bigcup_{n \in \N} \MP_n \\
				& \subset \MB(X)
			\end{align*}
			\item Let $x \in X$ and $\ep >0$. Suppose Since $\limsup\limits_{n \rightarrow \infty} \bigg[ \sup\limits_{S \in \MP_n} \diam(S) \bigg]  = 0$, there exists $N \in \N$ such that for each $n \geq N$ and $S \in \MP_n$, $\diam(S)< \ep$. Since $\MP_N$ is a partition, there exists $S_x \in \MP_N$, such that $x \in S_x$. Then 
			\begin{align*}
				\inf\limits_{S \in \pi_2(\MC|_x)} \diam(S)
				& \leq \diam(S_x) \\
				& < \ep 
			\end{align*} 
			Since $\ep > 0$ is arbitrary, $\inf\limits_{S \in \pi_2(\MC|_x)} \diam(S) = 0$. Hence $\MC$ is fine at $x$.  
			\item Let $\MC \subset \MV(\MP)$ and $Z \subset \pi_1(\MC)$. Suppose that for each $x \in Z$, $\MC$ is fine at $x$. Let $z \in Z$. \tcb{Define $\pi_n: X \rightarrow X/ \sim_n$ as in the analysis notes -ultrametric spaces.} Since $Z \subset \pi_1(\MC)$, there exists $n \in \N$ such that $\pi_n(z) \in \MC$. Set $n_z = \min \{n \in \N: \pi_n(z) \in \MC \}$. Then $\{\pi_{n_z}(z): z \in Z\}$ is a disjoint cover of $Z$. \\
			\tcb{FINISH!!!: WTS this set is countable or can take a countable subcover using separability that $\mu$-covers $Z$}. I think the interiors of $\pi_{n_z}(z)$ need to be nonempty. 
			
			Since $X$ is separable, $Z$ is separable. Thus, there exists $(z_j)_{j \in \N} \subset Z$ such that $(z_j)_{j \in \N}$ is dense in $Z$.
			\begin{enumerate}
				\item Choose
				\item 
				\item 
	...
	\begin{ex}
		Let $(X, d)$ be a metric space, $\mu, \al, \be \in \MM^+(X)$ and $\MV$ covering relation on $X$. Suppose that $\MV$ is $\mu$-Vitali. Let $c > 0$ and $A \subset X$. If $A \subset \bigg\{x \in X: \liminf\limits_{\MV \rightarrow x} \al / \be \leq  \bigg \}$  
	\end{ex}
