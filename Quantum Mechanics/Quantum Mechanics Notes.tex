...
\end{enumerate} 
The difference between the simultaneous eigenstates in the spin case and in the orbital case is that in the spin case, the eigenstates are not functions of position.   
\end{defn}
