...
\DeclareMathOperator{\clset}{clSets}
\DeclareMathOperator{\Intset}{IntSets}
\DeclareMathOperator*{\Punct}{\text{Punct}} 
\DeclareMathOperator*{\opn}{\MN^{opn}} 
\DeclareMathOperator*{\supSet}{supSet} 
\DeclareMathOperator*{\infSet}{infSet} 
...
\DeclareMathOperator*{\prmj}{\text{prime}_{\vee}} 
\DeclareMathOperator*{\prmm}{\text{prime}_{\wedge}} 
\DeclareMathOperator*{\irrj}{\text{irred}_{\vee}} 
\DeclareMathOperator*{\irrm}{\text{irred}_{\wedge}} 

% find where used and change, want to reserve \Rel for category of relations 
...
\DeclareMathOperator*{\Rel}{\text{\tbf{Rel}}}
