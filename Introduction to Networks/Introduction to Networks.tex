...
\begin{document}
	...
	\begin{proof}
	IDK, would like to show. I think I can show $\Aut(X, \MB(X), \mu)$ is compact and that the action is continuous. This would immediately imply that the orbits are closed. 
	\end{proof}
